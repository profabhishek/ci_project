...
<section class="meacontent">	
	...
	<div class="blue-heading col-md-12 " style="margin-bottom:0;">
			 ...
			 <form method="post" action="<?php echo base_url();?>admin/downloadAllExpenditureReport/<?php echo $this->uri->segment(3); ?>" enctype="multipart/form-data" id="frm_details_ngo" name="frm_details_ngo" style="width: 100%;position: relative;top: -43px;
">
         ...
         <div class="box-body">
        	<table id="tbl_report" class="table table-striped table-bordered" style="width:100%;">
		 	...
		 	<tbody>
		 		<tr>
		 			<td>
		 				<a href="<?php echo site_url();?>admin/download_zip/<?php echo $this->uri->segment(3);?>/<?php echo $this->uri->segment(4); ?>">Download Zip</a>	  			 				
		 			</td>
		 		</tr>
		 	</tbody>
		 	</table> 	
