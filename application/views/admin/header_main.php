...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" type="text/css" href="<?php echo site_url();?>assets/site/main/css/AdminLTE.min.css"/>
  <!-- Date Picker -->
  <link rel="stylesheet" href="<?php echo site_url();?>assets/site/main/css/datetimepicker.css">
  <!-- Plugins (jvectormap, wysihtml5) not present locally – omitted -->
...
<!-- Highcharts and missing plugins omitted (not available locally/offline) -->
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo site_url();?>assets/site/main/images/default_avatar.png" class="user-image" alt="User Image">
              <span class="hidden-xs">Super Admin</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo site_url();?>assets/site/main/images/default_avatar.png" class="img-circle" alt="User Image">
