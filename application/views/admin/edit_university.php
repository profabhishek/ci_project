			...
			<?php echo form_open('admin/updateUniversity',array('class'=>'form-horizontal')); ?>
              <div class="box-body">
                <div class="form-group">
				 ...
				 <input class="form-control" disabled="disabled" id="university_name" name="university_name" placeholder="University Name" type="text" value="<?php echo $university[0]['statename']?>" required="true">		
				  ...
				  <?php if($university[0]['university_type'] == 4){$type = "Guru's";}?>
				   <input class="form-control" disabled="disabled" id="university_name" name="university_name" placeholder="University Name" type="text" value="<?php echo $type;?>" required="true">	
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
				   <input class="form-control" disabled="disabled" id="university_name" name="university_name" placeholder="University Name" type="text" value="<?php echo $university[0]['name'];?>" required="true">	
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
				   <input class="form-control" disabled="disabled" id="university_name" name="university_name" placeholder="University Name" type="text" value="<?php echo $university[0]['link'];?>" required="true">	
