...
var statesarray = JSON.parse('<?php echo $states_array;?>');
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Application 
        <small>Total Confirmation</small>
      </h1>
      <ol class="breadcrumb">
...
<form id="form-filter" class="form-horizontal">
			...
			<div class="col-md-4">
					...
					<div class="col-md-6 pdright pdleft">
						<select id="status" name="status" class="selectpicker form-control" required="true">
							<option value="">Select</option>
						  <?php
						  $status = $this->common_model->getAllStatus();
    ...
    <section class="content">
      ...
      <div class="row">
    	...
    	<div class="box">
			...
			<div class="pull-right"><a href="<?php echo site_url();?>admin/downloadTotalMisionApplication" target ="__blank">
			<img style="width: 32px; height: 30px; margin-left: 16px;" src="<?php echo site_url();?>assets/site/main/images/xls_icon.png"/></a></div>
			<div class="pull-right"><a href="<?php echo site_url();?>admin/downloadTotalConfirmationPdf">
			<img style="width: 32px; height: 30px; margin-left: 16px;" src="<?php echo site_url();?>assets/site/main/images/xls_icon.png"/></a></div>
			</div>
