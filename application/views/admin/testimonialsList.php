	       	...
	       	<tbody>
				...
				<tr>
				   ...
				   <?php } ?>
					...
					<td><a href = "<?php echo $testimonial['testimonials_url'];?>" target = "__blank"><?php echo $testimonial['testimonials_url'];?></a></td>
					<td><?php echo date('d/m/Y',strtotime($testimonial['validated_upto']));?></td>						
					<td><?php
					$status = strtotime(date('Y-m-d'))  > strtotime($testimonial['validated_upto']) ? "<span style='color:red'>ARCHIEVED</span>":"<span style='color:green'>ACTIVE</span>";
					echo $status;
					?></td>						
					 <td>
                  <a href="<?php echo site_url('admin/editTestimonials/'.$testimonial['id']);?>"  class="icon_link edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
				<span class="space">&nbsp;&nbsp;&nbsp;</span>
				<a href="javascript:void(0);"onclick="deleteTestimonials('<?php echo $testimonial["id"];?>');" class="icon_link delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
				</td>
				</tr>
				<?php	
				$counter++;
