  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Application 
        <small>Total Mission Forword Application</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      ...
      <div class="row">
      	<div class="col-xs-12">
    	<div class="box">
			<div class="box-header">Total Misison Forword Application
			<div class="pull-right"><a href="<?php echo site_url();?>admin/downloadTotalMisionForwordApplication">
			<img style="width: 32px; height: 30px; margin-left: 16px;" src="<?php echo site_url();?>assets/site/main/images/xls_icon.png"/></a></div>
			<div class="pull-right"><a href="<?php echo site_url();?>admin/downloadTotalMisionForwordApplicationPdf" target = "__blank">
			<img style="width: 32px; height: 30px; margin-left: 16px;" src="<?php echo site_url();?>assets/site/main/images/xls_icon.png"/></a></div>
			</div>
