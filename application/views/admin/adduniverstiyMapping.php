...
function updateStateid(id) {
   ...
   <div class="content-wrapper">
       ...
       <section class="content-header">
           ...
           <ol class="breadcrumb">
               <li><a href="<?php echo site_url();?>admin/allmissions"><i class="fa fa-dashboard"></i> Universtiy
                       Mapping</a></li>
                       ...
                       <div class="box-body">
                           <div class="form-group">
                               <label for="inputPassword3"
                                   class="col-sm-2 control-label">Regional Office</label>
                               <div class="col-sm-10">
						  ...
						  ?>
                           ...
                           <div class="form-group">
                               <label for="inputPassword3"
                                   class="col-sm-2 control-label">UG Course Type</label>
                               <div class="col-sm-10">
                                   <select multiple="true"
                                       class="form-control"
                                       id="ug_courser_typ_id"
                                       name="ug_courser_typ_id[]"
						  ...
						  ?>
                           ...
                           <div class="form-group">
                               <label for="inputPassword3"
                                   class="col-sm-2 control-label">PG Course Type</label>
                               <div class="col-sm-10">
                                   <select multiple="true"
                                       class="form-control"
                                       id="pg_courser_typ_id"
                                       name="pg_courser_typ_id[]"
                                       style="min-height:195px;">
						  ...
						  ?>
                           ...
                           <div class="form-group">
                               <label for="inputPassword3"
                                   class="col-sm-2 control-label">Mphil Course Type</label>
                               <div class="col-sm-10">
                                   <select multiple="true"
                                       class="form-control"
                                       id="mhphil_courser_typ_id"
                                       name="mhphil_courser_typ_id[]"
                                       style="min-height:195px;">
						  ...
						  ?>
                           ...
                           <div class="form-group">
                               <label for="inputPassword3"
                                   class="col-sm-2 control-label">Phd Course Type</label>
                               <div class="col-sm-10">
                                   <select multiple="true"
                                       class="form-control"
                                       id="phd_courser_typ_id"
                                       name="phd_courser_typ_id[]"
                                       style="min-height:195px;">
						  ...
						  ?>
                           ...
                           <div class="form-group">
                               <label for="inputEmail3"
                                   class="col-sm-2 control-label">University Type</label>
                               <div class="col-sm-10">
                           ...
                           <div class="form-group">
                               <label for="inputEmail3"
                                   class="col-sm-2 control-label">Universtiy Name</label>
                               <div class="col-sm-10">
                                   <select name="universtiy"
                                       id="universtiy"
                                       onchange="updateStateid(this.id)"
                                       class="form-control">
                                       <option value=""
                                           label="">---- University Name ---</option>
                                       <?php
						  ...
						  ?>
                           ...
                           <div class="form-group">
                               <label for="inputPassword3"
                                   class="col-sm-2 control-label">University Name</label>
                               <div class="col-sm-10">
                           ...
                           <div class="form-group">
                               <label for="inputPassword3"
                                   class="col-sm-2 control-label">State Id</label>
                               <div class="col-sm-10">
                                   <input class="form-control"
                                       id="state_id"
                                       name="state_id"
