  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url();?>admin/allmissions"><i class="fa fa-dashboard"></i> Application List</a></li>
    ...
    <section class="content">
      ...
      <div class="row">
      	<div class="col-xs-12">
    	<div class="box">
			<div class="box-header">Total Application
			<div class="pull-right"><a href="<?php echo site_url();?>admin/downloadCountryWiseTotalMisionApplication">
	      	...
	      	<table class="table table-bordered table-striped myMissions">
	       	...
	       	<tbody>
				...
				<tr>
					...
					<td><?php echo $totalApp['Country'];?></td>
