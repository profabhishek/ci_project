              	...
              	<div class="name-sec col-xs-12 col-sm-9 col-md-9 pdleft pdright">
					...
					else
					{
						...
						<table id="tbl_uni" style="width: 100%;">
										...
										<tbody>
											<tr>
												<td><?php $university_first = $this->common_model->getUniversityByIdOld($applicaitonStepOne[0]['universty_choice']); echo $university_first[0]['name'];?></td>
												<td><?php $university_second =  $this->common_model->getUniversityByIdOld($applicaitonStepOne[0]['universty_choice_two']);echo $university_second[0]['name'];?></td>
												<td><?php $university_three = $this->common_model->getUniversityByIdOld($applicaitonStepOne[0]['universty_choice_three']); echo $university_three[0]['name'];?></td>
											</tr>
										</tbody>
									</table>
						<?php
