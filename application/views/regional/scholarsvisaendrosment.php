...
<section class="meacontent">	
	...
	<div class="tab-content footr">		
	  <div id="home" class="tab-pane fade in active">	   
	    <form id="form-visa" action="<?php echo site_url();?>regional/visaapply/<?php echo $appno; ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
	    <div class="box-body">
	    	  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">	   	 
				 ...
				 <div class="form-group col-xs-5" style="height: 45px;">
					 <label for="comment" class="col-sm-4 control-label">Name: </label> 
						<div class="form-group col-md-8">
						 <input type="text" class="form-control" placeholder="Place" id="mission_place" name="mission_place" />
						</div>
				 </div>
