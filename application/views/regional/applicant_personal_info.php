	  ...
	  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
					...
					<table class="table">
						...
						<tbody>
							...
							?>
								...
								<td><?php echo $counter; $counter++;?></td>
								<td><?php echo $doctypes['otherDoc']['title'];?><span class="text-red">*</span></td>
								<td>
								<?php
								  if(array_key_exists($doctypes['otherDoc']['type'],$docsArray))
								  {
      	...
      	<div class="name-sec col-xs-4 col-sm-2 col-md-2">
      	 <div class="name-sec col-xs-4 col-sm-2 col-md-12 pull-right">
			  <a href="<?php echo site_url();?>regional/new_applications" class="form-control sbmt">Cancel</a>
			  </div>
				</div>
              </div>
              <div class="box-body fade forwarddiv_regional">                       
              <?php echo form_open('regional/forwardtohqrs/'.$this->uri->segment(3),array('enctype'=>'multipart/form-data')); ?>
              <div class="form-group col-xs-3">
					...
					<div class="form-group col-xs-6">
						...
						<div class="form-group col-xs-6">
					 <label for="inputEmail3" class="col-sm-6">Enter University Confirmed Couse<span class="text-red">*</span></label>
					  <div class="col-sm-4">
					...
					<div class="form-group col-xs-4">
					 <label for="inputEmail3" class="col-sm-6">Enter Institute Name<span class="text-red">*</span></label>
					  <div class="col-sm-6">
					<input type="text" class="form-control" name="institute_name" id="institute_name" required = "true"/>
					</div>
					</div>
					<div class="name-sec col-xs-4 col-sm-2 col-md-3 pull-right">				
				 		<input type="submit" class="form-control sbmt" value="Confirm to Hqrs"/>
              		</div>
              		<?php echo form_close(); ?>
              </div>
              <!-- /.box-body -->
