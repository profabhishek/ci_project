	...
	?>
	  ...
	  <!--<h3 class="text-center" id="h5_cnetr">Applicant's Acceptance Forwarded to Hqrs/RO</h3>-->	 
              ...
              <div class="box-body">
				...
				<br/>
				<hr>	
				<h3 style="text-align: center;">Update Arrival Status of Applicant</h3>			
      			<form id="form-visa" action="<?php echo site_url();?>regional/updateArrivalStatus/<?php echo $this->uri->segment(3); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
	      <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
	      <input type="hidden" name="travelId" id="travelId" value="<?php echo $this->uri->segment(4); ?>">
	     <div class="box-body">
		    ...
		    <label for="inputEmail3" class="col-sm-3 control-label  pdright pdleft" class="form-control">Status</label>
		    <div class="col-sm-6">
		     	<select id="arrival_status" name="arrival_status" class="form-control" required="true">
		    ...
		    <div class="form-group col-xs-4">
		    <label for="inputEmail3" class="col-sm-3 control-label  pdright pdleft" class="form-control">Date of Arival</label>
		    <div class="col-sm-6">
		     	<input type="text" name="travel_arrival_date" id="travel_arrival_date" class="form-control datepicker_arrival" placeholder="Arival Date"/>
		    </div>	
		  </div>
		 <div class="col-md-4 pull-right pdleft">
