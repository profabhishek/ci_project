...
<section class="meacontent">	
	<div class="col-xs-10 form_head">		
		...
		<h4 class="text-center caps">Financial Year : <?php echo $this->uri->segment(4); ?></h4>	
	...
	<div class="blue-heading col-md-12" style="margin-bottom:0;">
			 <h3>Expenditure Statement of Applicant: <?php echo $this->uri->segment(3); ?> for FY - <?php echo $this->uri->segment(4); ?></h3>
...
$data = $this->common_model->getConfirmationofApplicationIds($ano);
						 ...
						 $uni = $this->common_model->getUniversityById($data[0]->regional_university);echo $uni[0]['name'];
						    ...
						    ?>	</td>
	  			 			...
	  			 			<tr>
	  			 				<td width="200px" style="background:#fff;">Joining Date</td>
	  			 				<td> <?php
	  			 				
								 if(count($mappingData)>0 && $mappingData[0]['joining_date'] != "")
								 {
								 	echo $mappingData[0]['joining_date'];
								 }
								 else
								 {
	  			 			...
	  			 			<tr>
	  			 				<td width="200px" style="background:#fff;">Completion Date</td>
	  			 				<td> <?php
								   if(count($mappingData)>0 && $mappingData[0]['completion_date'] != "")
								 {
								 	echo $mappingData[0]['completion_date'];
								 }
								 else
								 {
								 	echo "Not Updated Yet";
	  			 			...
	  			 			<tr>
	  			 				<td width="200px" style="background:#fff;">Arrival Date</td>
	  			 				<td> <?php
								$anooo = $this->uri->segment(3);
								$travelpl = $this->common_model->getTravelPlan($anooo);
	  			 	...
	  			 	<tbody>
	  			 		<tr>
	  			 			<td>
								...
								{
									echo "Bank Detail Not Updated Yet!";
								}
	  			 				?>	  			 				
	  			 			</td>
	  			 		</tr>
	  			 	...
	  			 	<tbody>
	  			 		<tr>
	  			 			<td>
								...
								{
									echo "Residential Permit Detail Not Updated Yet!";
								}
	  			 				?>	  			 				
	  			 			</td>
	  			 		</tr>
	     			...
	     			<table id="tbl_report" class="table table-striped table-bordered" style="width:100%;">
						 		<thead>
						 			<tr>
						 				<th colspan="6" style="background:#F0F8E3;"> Expenditure Statement of Application Number: <?php echo $this->uri->segment(3); ?> for FY - <?php echo $this->uri->segment(4); ?></th>
						 		...
						 		<tbody>
							 		...
							 		<th> Total</th>
						 				...
						 				//print_r($advstipendDetails);
						 					...
						 					{						 						
												foreach($advstipendDetails as $adstpnd)
							 					{
							 						//echo "<pre>";print_r($adstpnd);
							 						echo (($adstpnd['First_Quarter'] !=NULL) && ($adstpnd['First_Quarter'] !="")) ? "<td>".$adstpnd['First_Quarter']."</td>" : "<td>0</td>";
													echo (($adstpnd['Second_Quarter'] !=NULL) && ($adstpnd['Second_Quarter'] !="")) ? "<td>".$adstpnd['Second_Quarter']."</td>" : "<td>0</td>";
													echo (($adstpnd['Third_Quarter'] !=NULL && $adstpnd['Third_Quarter'] !="")) ? "<td>".$adstpnd['Third_Quarter']."</td>" : "<td>0</td>";
													echo (($adstpnd['Fourth_Quarter'] !=NULL && $adstpnd['Fourth_Quarter'] !="")) ? "<td>".$adstpnd['Fourth_Quarter']."</td>" : "<td>0</td>";
													
													$advstipendTotal = $adstpnd['First_Quarter'] + $adstpnd['Second_Quarter'] + $adstpnd['Third_Quarter'] + $adstpnd['Fourth_Quarter'];
...
<tr>
        ...
        <table id="tbl_report" class="table table-striped table-bordered" style="width:100%;">
		 	...
		 	<tbody>
		 		<tr>
		 			<td>
		 				<a href="<?php echo site_url();?>regional/download_zip/<?php echo $this->uri->segment(3);?>/<?php echo $this->uri->segment(4); ?>">Download Zip</a>	  			 				
		 			</td>
		 		</tr>
		 	</tbody>
		 	</table> 	
