...
<?php
	...
	<div class="col-xs-10 form_head">		
		...
		<h5 class="text-center">To be filled by Alumini</h5>
		
	</div>
	<script type="text/javascript">
		window.history.pushState({}, "Indian Council for Cultural Relations",  baseURL + 'regional/alumniApplications?appno=' + '<?php echo $get_application_number; ?>');
	</script>
	...
	<div class="tab-content footr">		
	  <div id="home" class="tab-pane fade in active">	   
	    <form id="form-expenditure" action="<?php echo site_url();?>regional/savesAlumniData" method="post" class="form-horizontal" enctype="multipart/form-data">
	    <div class="box-body" style="position: relative;">
	    	 <h3 class="hd">Personal Details</h3>
	    	  ...
	    	  <input type="hidden" id="application_id" name="application_id" value="<?php echo $get_application_number;?>">	
				...
				<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">Awards & Recognition (if any)<span class="text-red"></span></label>
					    <div class="col-sm-8">
				...
				<div class="form-group col-xs-9">
					...
					<div class="img-alumni">
						...
						<a id="openpic" title = "Note: (Profile Image should be less than equal to 200 KB and in JPG/JPEG/PNG format)"href="javascript:void(0);">Upload Alumni Image</a><hr>
