...
<section class="meacontent">	
	<div class="col-xs-10 form_head">		
		...
		<h3 class="text-center caps">Regional Office <?php echo $regionName[0]['name'];?> Profile</h3>	
	</div>
	...
	<div class="tab-content footr">		
	  <div id="home" class="tab-pane fade in active">	   
	    <form id="form-expenditure" action="<?php echo site_url();?>regional/profile" method="post" class="form-horizontal" enctype="multipart/form-data">
	    <div class="box-body">
	    <?php
	    	...
	    	?>
	    	  ...
	    	  <input type="hidden" name="id" id="id" value="<?php echo $regionName[0]['id'];?>">			
					<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">Name of Head of Dept.</label>
					    <div class="col-sm-8">					      
						  <input type="text" class="form-control" name="name" id="name" placeholder="Name" value="<?php echo $regionName[0]['name'];?>">
					    </div>
					</div>
              		<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">Mobile Number</label>
					    <div class="col-sm-8">					   
						<input type="text" class="form-control" id="mobile_no" name="mobile_no" value="<?php echo $regionName[0]['mobile_no'];?>" placeholder="Mobile Number"/>						
					...
					<div class="form-group col-xs-9">
					    ...
					    <div class="col-sm-8">
					    	<input type="text" readonly="true" class="form-control" id="email" name="email" value="<?php echo $regionName[0]['email'];?>" placeholder="Email Id"/>
					    </div>
					</div>
					<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">Office Address</label>
					    <div class="col-sm-8">
					    	<input type="text" class="form-control" id="office_address" name="office_address" value="<?php echo $regionName[0]['office_address'];?>" placeholder="Office Address"/>
					    </div>
					</div>
					<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">Telephone</label>
					    <div class="col-sm-8">
					    	<input type="text" class="form-control" id="telephone_number" name="telephone_number" value="<?php echo $regionName[0]['telephone_number'];?>" placeholder="Telephone"/>
					    </div>
					</div>
					<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">Fax Number</label>
					    <div class="col-sm-8">
					    	<input type="text" class="form-control" id="fax_number" name="fax_number" value="<?php echo $regionName[0]['fax_number'];?>" placeholder="Fax Number"/>
					    </div>
					</div>
				<br/><br/>		
			</div>
