...
<?php
	...
	<script type="text/javascript">
		window.history.pushState({}, "Indian Council for Cultural Relations",  baseURL + 'regional/alumniApplication/' + '<?php echo $appno; ?>');
	</script>
	...
	<div class="tab-content footr">		
	  <div id="home" class="tab-pane fade in active">	   
	    <form id="form-expenditure" action="<?php echo site_url();?>regional/saveAlumniData/<?php echo $appno;?>" method="post" class="form-horizontal" enctype="multipart/form-data">
	    	 ...
	    	 <h3 class="hd">Personal Details</h3>
	    	  ...
	    	  <input type="hidden" id="application_id" name="application_id" value="<?php echo $appno;?>">	
					...
					<div class="form-group col-xs-9">
					    ...
					    <div class="col-sm-8">
						     <select id="nationality" name="nationality" class="form-control" onchange = "return getMissonById(this.value)">
					...
					<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">Application Made Through</label>
					    <div class="col-sm-8">
						     <select id="mission_made_through" name="mission_id" class="form-control">
						     	<option value="">Select</option>
					...
					<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">Passport No</label>
					    <div class="col-sm-8">
					     <input type="text" name="passport_no" class="form-control" placeholder="Passport No" id="passport_no" pattern="^[a-zA-Z0-9 ]+$" title="A-Z a-z 0-9 ' '"/>
					    </div>
						

					</div>
					<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">a) Date of Issue</label>
					    <div class="col-sm-3">
						...
						<div class="form-group col-xs-9">
						  <label for="inputEmail3" class="col-sm-2">b) Date of Expiry</label>
						<div class="col-sm-3">
					...
					<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">c) Place of Issue</label>
					    <div class="col-sm-8">
					       <input type="text" class="form-control" placeholder="Place of Issue" id="passport_issue_place" name="passport_issue_place"  pattern="^[a-zA-Z ]+$" title="A-Z a-z ' '"/>
					    </div>
					</div>
		    	...
		    	<input type="text" name="other_city" id="other_city" placeholder="Other City" class="form-control"/>
					...
					<!-----<h3 class="hd">Status Details</h3>-->
					
					<!---<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">Date of Forwarding</label>
					    <div class="col-sm-4">
					      <input type="text" class="form-control datepicker" id="forwarding_date" name="forwarding_date" placeholder="Forwarding Date" required="true">
					    </div>
					</div>
					<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">University Letter</label>
					    <div class="col-sm-4">
					    	 <select id = "university_letter" class = "form control" name = "university_letter" onchange="showUpload(this.id);">
						  ...
						  <option value = "2">No</option>
							   ...
							   <div class="col-sm-4 fade uni_upload">
		    	<input type="file" name="upload_university_letter" id="uni_upload" class="form-control"/>
		    </div>
					</div>--->	
					...
					<!---<div class="form-group col-xs-9">
					    ...
					    <div class="col-sm-4">
					    	 <select id = "university_response" class = "form control" name = "university_response" required>
						  <option>-----Select------</option>
						  <option value = "1">Yes</option>
					...
					<!---<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">Departure Date</label>
					    <div class="col-sm-4">
					      <input type="text" class="form-control datepicker" id="date_of_departure" name="date_of_departure" placeholder="Departure Date" required="true">
					    </div>
					</div>-->
					
					
					<!---<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">Arrival Date by Mission</label>
					    <div class="col-sm-4">
					      <input type="text" class="form-control datepicker" id="arrival_date_by_mission" name="arrival_date_by_mission" placeholder="Arrival Date by Mission" required="true">
					    </div>
					</div>-->
					
					<!-----<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">Travel Plan Document</label>
					    <div class="col-sm-4">
					    	 <select id = "travel_plan_document" class = "form control" name = "travel_plan_document" onchange = "showTravelDoc(this.id)";>
						  <option>-----Select------</option>
						  <option value = "1">Yes</option>
						  <option value = "2">No</option>
						  </select>
					    </div>
			<div class="col-sm-4 fade travel_doc_upload">
		    	<input type="file" name="upload_travel_doc" id="travel_doc_upload" class="form-control"/>
		    </div>
					</div>---->	
					
					<!---<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">Flight No.</label>
					    <div class="col-sm-4">
					      <input type="text" class="form-control" id="flight_no" name="flight_no" placeholder="Flight No" required="true">
					    </div>
					</div>--->
					...
					<!---<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">Arrival Date</label>
					    <div class="col-sm-4">
					      <input type="text" class="form-control datepicker" id="date_of_arrival" name="date_of_arrival" placeholder="Arrival Date" required="true">
					    </div>
					</div>--->
