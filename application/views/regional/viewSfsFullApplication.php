...
">
	 ...
	 <?php
	  ...
	  <?php  
			if(isset($include) && $include == 'applicant_personal_info_preview')
					{
						?>
						<div class="box-body" <?php if(isset($include) && $include == 'applicant_personal_info_preview'){ echo 'style="display:none;"'; } ?>">
						<?php
					}
			?>
				...
				?>
					...
					{
						?>
						<div class="box-body" <?php if(isset($include) && $include == 'applicant_education_info_preview'){ echo 'style="display:none;"'; } ?>">
						<?php
				...
				<?php  
					...
					{
					?>
				<table style="width:100%;" <?php if(isset($include) && $include == 'applicant_education_info_preview'){ echo 'style="display:none;"'; } ?>">
					<?php
					}
					elseif(isset($include) && $include == 'applicant_personal_info_preview')
					{
					?>
				    <table style="width:100%;" <?php if(isset($include) && $include == 'applicant_personal_info_preview'){ echo 'style="display:none;"'; } ?>">
					<?php
					}
					?>
					<tbody>
	...
	<br/>
	<br/>
	<div class="tab-content docsdiv" <?php if(isset($include) && $include == 'applicant_personal_info_preview' || $include == 'applicant_education_info_preview' || $include == 'applicant_other_info_preview'){ echo 'style="display:none;"';}?>>
