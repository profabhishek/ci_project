<?php
// Variables passed from controller – declared here to satisfy static analysis
$userImage        = isset($userImage)        ? $userImage        : '';
$missions         = isset($missions)         ? $missions         : [];
$applicaitonStepOne   = isset($applicaitonStepOne)   ? $applicaitonStepOne   : [];
$applicaitonStepTwo   = isset($applicaitonStepTwo)   ? $applicaitonStepTwo   : [];
$applicaitonStepThree = isset($applicaitonStepThree) ? $applicaitonStepThree : [];
$applicaitonDocuments = isset($applicaitonDocuments) ? $applicaitonDocuments : [];
$registerData     = isset($registerData)     ? $registerData     : [];
?>
<style type="text/css">
	...
	<div class="tab-content detailpagepdf">		
              ...
              <div class="box-body">
              	...
              	<div class="name-sec col-xs-12 col-sm-9 col-md-9 pdleft pdright">
					<table id="fbl_main" style="width: 100%;">
						...
						<tbody>
						<tr>
							<td style="font-weight:bold;"><label id="lbl">Application Made Through</label>				</td>
							 ...
							 <?php
								...
								{					
									...
									?>							
													...
													<?php if(count($applicaitonStepOne) > 0 && count($applicaitonStepOne[0]['programme']) > 0 && $applicaitonStepOne[0]['programme'] == 4 && $applicaitonStepOne[0]['universty_choice'] == 189 || $applicaitonStepOne[0]['universty_choice'] == 176)
						{
	 ?> 
	 
	 
	 <tr>
							<td style="font-weight:bold;"><label id="lbl">GMAT Score</label></td>
							<td colspan="2">:&nbsp;&nbsp;
						
							 		
								<?php if(!empty($applicaitonStepOne)) echo $applicaitonStepOne[0]['gmat_score'];
	 ...
	 <?php
					...
					?>
						...
						<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;In case none of three universities of my choice agree to give me admission to the course of my choice, ICCR can forward my &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;application to other universities in other cities of India. 		<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
						<br/>						
						<?php 
								if(!empty($applicaitonStepOne)) 
								{
              	...
              	<div class="passport-sec col-xs-12 col-sm-12 col-md-12 pdleft pdright">
					<table class="table">
						...
						<tbody>
							...
							<?php if(count($applicaitonStepOne[0]['programme']) > 0 && $applicaitonStepOne[0]['programme'] == 4 && $applicaitonStepOne[0]['universty_choice'] == 189 && $applicaitonStepOne[0]['course_type'] == 6 || $applicaitonStepOne[0]['universty_choice_two'] == 189 && $applicaitonStepOne[0]['course_type'] == 6 || $applicaitonStepOne[0]['universty_two_three'] == 189 && $applicaitonStepOne[0]['course_type'] == 6 || $applicaitonStepOne[0]['universty_choice'] == 205 && $applicaitonStepOne[0]['course_type'] == 6 || $applicaitonStepOne[0]['universty_choice_two'] == 205 && $applicaitonStepOne[0]['course_type'] == 6 || $applicaitonStepOne[0]['universty_choice_three'] == 205 && $applicaitonStepOne[0]['course_type'] == 6 || $applicaitonStepOne[0]['universty_choice'] == 176 && $applicaitonStepOne[0]['course_type'] == 6 || $applicaitonStepOne[0]['universty_choice_two'] == 176 && $applicaitonStepOne[0]['course_type'] == 6 || $applicaitonStepOne[0]['universty_choice_three'] == 176 && $applicaitonStepOne[0]['course_type'] == 6 )
							{
								?>
							<tr>
								<td><?php echo $counter; $counter++;?></td>
								...
								<?php
								  ...
								  {
								  ?>
								 <a href="#"  data-toggle="modal" data-target="#gmatScoreDiv">Upload</a>
								  <?php	
								  }
								  ?>
