    ...
    <div  class="container" style="min-height:410px;padding-top:15px;">	
		...
		<form id="form-filter" class="form-horizontal">
			<div class="filters col-md-12 form-group">
					<div class="col-md-4">
					<label for="inputEmail3" class="col-sm-5 pdleft">Financial Year</label>
			...
			<!----<div class="col-md-4">
					...
					<div class="col-md-6 pdright pdleft">
						<select id="year" name="year" class="selectpicker form-control" required="true">
						<option value="">Select</option>
...
$(document).ready(function() {
      ...
      "paging":   false,
        ...
        "ajax": {
            "url": "<?php echo site_url('regional/getCountRegional')?>",
            "type": "POST",
            "data": function ( data ) {
