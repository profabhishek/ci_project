	  ...
	  <div id="home" class="tab-pane fade in active">	   
	    ...
	    <form id="form-filter" class="form-horizontal">
			...
			<div class="filters col-md-12 form-group">
				...
				<div class="col-md-4">
					<label for="inputEmail3" class="col-sm-5">Scheme Type</label>
					<div class="col-md-6 pdright pdleft">
						<select id="schemes" name="schemes" class="selectpicker form-control" required="true">
							<option value="">Select</option>
							<option value="1">Agency</option>
							<option value="2">Non-Agency</option> 
						</select>
					</div>
				</div>
...
$(document).ready(function(){
	...
	var b1 = 0; var b2=0; var b3=0; var b4=0; var bt =0;
	var ro1 = Number($('.rotable tbody tr:eq(0) td:eq(1)').text());
	b1 = ro1 - roQ1;
	
	var ro2 = Number($('.rotable tbody tr:eq(0) td:eq(2)').text());
	b2 = ro2 - roQ2;
	
	var ro3 = Number($('.rotable tbody tr:eq(0) td:eq(3)').text());
	b3 = ro3 - roQ3;
	
	var ro4 = Number($('.rotable tbody tr:eq(0) td:eq(4)').text());
	b4 = ro4 - roQ4;
	
	var rottt = Number($('.rotable tbody tr:eq(0) td:eq(5)').text());
	bt = rottt - rototal;
	
	var trrrb = "<tr>";
	trrrb += "<td><b>Fund Balance</b></td>";
	trrrb += "<td>"+b1+"</td>";
	trrrb += "<td>"+b2+"</td>";
	trrrb += "<td>"+b3+"</td>";
	trrrb += "<td>"+b4+"</td>";
