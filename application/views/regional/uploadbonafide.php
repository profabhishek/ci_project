...
<section class="meacontent">	
	<div class="col-xs-10 form_head">		
		...
		<h3 class="text-center caps">Issuing Bonafide Certificate of Applicant</h3>
	...
	<div class="tab-content footr" style="min-height:300px;">		
	  <div id="home" class="tab-pane fade in active">	   
	    <form id="form-visa" action="<?php echo site_url();?>regional/createBonafide/<?php echo $appno; ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
	    ...
	    <div class="form-group col-xs-10">
					    <label for="inputEmail3" class="col-sm-3 control-label  pdright pdleft">Upload Bonafide Certificate</label>
					    <div class="col-sm-3">
