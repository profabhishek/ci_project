...
<section class="meacontent">	
	...
	<div class="headsec container">Welcome <?php echo $regionName[0]['name'];?> to ICCR Scholarship Portal</div>
	<div  class="container" style="min-height:410px;padding:0px;">		
	<div class="tab-content footr">		
	  <div id="home" class="tab-pane fade in active ">	   
	    <form id="form-visa" action="<?php echo site_url();?>regional/travelpaln/<?php echo $appno; ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
	     ...
	     <div class="box-body">
		   ...
		   <div class="form-group col-xs-10">
		    ...
		    <div class="col-sm-6">
		     	<?php $count = $this->common_model->getCountryById($applicaitonStepOne[0]['country']); echo $count[0]['country_name']; ?>
		    </div>	
		  </div> 		 
		   <div class="form-group col-xs-10">
		   ...
		   <div class="form-group col-xs-10">
		    ...
		    <div class="col-sm-6">
		     	<?php echo $course = $response[0]['confirmed_course']; ?>
		    </div>	
		  </div> 
		    <div class="form-group col-xs-10">
		    ...
		    <div class="col-sm-6">
		     	<?php
						...
						$alreadyUnderTaking = $this->common_model->getUnderTaking($appno);
		    ...
		    <div class="col-sm-6">
		     	<input type="text" name="travel_arrival_date" placeholder="Date of Arrival in India" id="travel_arrival_date" class="form-control datepicker_arrival" placeholder="Arival Date"/>
		    </div>	
		  </div> 
		    <div class="form-group col-xs-10">
		  ...
		  <div class="form-group col-xs-10">
		    ...
		    <div class="col-sm-6"> 
		     	<input type="text" name="cost_of_ticket" id="cost_of_ticket"  placeholder="Cost of Ticket" class="form-control"/>
		    </div>	
		  </div> 
		...
		<div class="form-group col-xs-10">
					    ...
					    <div class="col-sm-3">
					      <input type="file"  name="travel_plan_doc" id="travel_plan_doc"/>
					    </div>
						<a href="<?php echo site_url();?>regional/travelSchedule/<?php echo $appno;?>" >Download</a>
