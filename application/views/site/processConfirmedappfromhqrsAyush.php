...
?>
		...
		//echo "<pre>";print_r($applicaitonsResubmitStatus);
			...
			if(count($applicaitonStepOne) > 0 && $applicaitonStepOne[0]['course_type'] == 1 && $mappingData[0]['region_forward_mission_status'] == 1)
				{
...
?>
    ...
    <tbody>
						<tr>
                            ...
                            <td><?php $university = $this->common_model->getagreeconfirmationDataByMission($applicaitonStepOne[0]['application_no']);
							...
							<td>
							 ...
							 <td>
                                <?php
                              //echo "<pre>";print_r($mappingData);
							  $response = $this->common_model->getagreeconfirmationDataByMission($mappingData[0]['application_no']);
							   //echo "<pre>";print_r($response);
                                   if($mappingData[0]['region_forward_mission_status'] == 1) {
									   ?>
							...
							<td>
                                <?php
                              //echo "<pre>";print_r($mappingData);
                                   if($mappingData[0]['region_forward_mission_status'] == 1 && $mappingData[0]['scholar_acceptance'] == 1) {
                                        if ($university[0]['university_is_accept'] == 1) {
                                            ?>
									...
									elseif($mappingData[0]['region_forward_mission_status'] == 1 && $mappingData[0]['scholar_acceptance'] == 2) {
                                        if ($university[0]['university_is_accept'] == 1) {
											echo "Decline";
                                            ?>
                                            <!----<a target="_blank" href="<?php echo site_url(); ?>applicant/undertakingFromStudent/<?php echo $university[0]['application_id']; ?>/<?php echo $university[0]['regional_university']; ?>" target="_blank"><span class = "label label-success">Download</span></a>--->
