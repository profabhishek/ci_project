...
<section class="meacontent">
   ...
   <form id="form-process-personal-info"
      ...
      <div class="formrow">
         ...
         <div class="col-xs-12 col-sm-3 col-md-3">
            <label for="comment">14. Citizenship/Unique ID No.<span class="text-red">*</span></label>
            <input type="text"
               class="form-control capitalLetter"
               id="unique_id"
               name="unique_id"
      ...
      <div class="formrow">
         ...
         <!-- <?php 
            //$course_duration = '';
            //if (count($applicaitonStepOne) > 0) {
              //  $course_duration = $applicaitonStepOne[0]['course_duration'];
            ?>
            <div class="col-xs-12 col-sm-3 col-md-3">
                
                <label for="comment" title="Course Duration">22. Course Duration<span class="text-red">*</span></label>
                <select name="course_duration" id="selectDuration" class="form-control">
                    <option>Select</option>
                    <option value="<?php //echo $course_duration; ?>" <?php //if ($course_duration) {
               //                                                    echo "selected";
                                                              // } ?>>
                    <?php //echo $course_duration; ?></option>
            </select>
            </div>
            <?php //} else { ?>
            <div class="col-xs-12 col-sm-3 col-md-3 course_type fade" style="display: none;">
                <label for="comment" title="Course Duration">22. Course Duration<span class="text-red">*</span></label>
                <select name="course_duration" id="selectDuration" class="form-control">
                    <option>Select</option>
                </select>
         ...
         <div class="col-xs-12 col-sm-3 col-md-3 course_type">
            ...
            <div class="course_type fade"
               ...
               <?php
                  ...
                  ?>
               <select id="<?php
                  if ($student_type == 1 && $student_course_type == 1 || $student_type == 1 && $student_course_type == 4 || $student_type == 1 && $student_course_type == 9 || $student_type == 1 && $student_course_type == 2 || $student_type == 1 && $student_course_type == 3 || $student_type == 1 && $student_course_type == 6 || $student_type == 1 && $student_course_type == 5 || $student_type == 1 && $student_course_type == 9 || $student_type == 1 && $student_course_type == 12 || $student_type == 1 && $student_course_type == 13) {
                      echo 'course_type';
                  }
                  ; ?>"
                  name="course_type"
      ...
      <!-- <div class="formrow">
         <?php
            ...
            ?>
         <div class="col-xs-12 col-sm-3 col-md-3 cours_subject"
            required="true">
            ...
            <input type="text"
               ...
               class="form-control"
               required="true"
               value="<?php if (!empty($applicaitonStepOne)) echo $applicaitonStepOne[0]["course_subject"];  ?>" />
         </div>
         <?php
            }
            } else {
      ...
      <div class="formrow">
         <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <span class="note1"><strong>Note : </strong>ICCR provides scholarships only for
            courses in Central or State Goverment Universities. Candidates should be very
            ...
            University/Institute website to know the availability of course in that
            University and eligibility criteria for the courses of their choice.Those
            seeking admission to Ayurveda, Yoga, Unani, Siddha and Homoeopathy course must
            opt for <b>AYUSH</b> in the University choice.</span>
      ...
      <div class="formrow unidiv1"
         id="admission">
      <?php
         } elseif (isset($applicaitonStepOne[0]['programme'])) {
             if (count($applicaitonStepOne) > 0 && $applicaitonStepOne[0]['programme'] == 3 || $applicaitonStepOne[0]['programme'] == 4 || $applicaitonStepOne[0]['programme'] == 7 || $applicaitonStepOne[0]['programme'] == 8) {
             ?>
      <div class="formrow unidiv1"
         id="admission">
      ...
      <div class="formrow unidiv1"
         ...
         <div class="col-xs-12 col-sm-4 col-md-4 pdleft course_wish_study"
            id="course_wish">
            <label for="comment"
               title="Course choice 1">Sub Stream you wish to study 1<span
               class="text-red">*</span></label>
            <select id="course"
               onChange="getCourseData(this.value)"
               name="course"
               class="form-control course capitalLetter">
         ...
         <div class="col-xs-12 col-sm-4 col-md-4 pdleft course_wish_study"
            id="course_wish">
            <label for="comment">Sub Stream you wish to study <span
               class="text-red">*</span></label>
            <select id="course"
               name="course"
               class="form-control course capitalLetter">
         ...
         <?php
            ...
            ?>
         <div class="col-xs-12 col-sm-4 col-md-4 pdright fade course_wish_study"
            id="course_wish"
            style="display:none;">
            <label for="comment">Sub Stream you wish to study <span
               class="text-red">*</span></label>
         ...
         <div class="col-xs-12 col-sm-4 col-md-4 pdleft course_wish_study"
            id="course_wish">
            <label for="comment">Sub Stream you wish to study 1 <span
               class="text-red">*</span></label>
            <select id="course"
               onChange="getCourseData(this.value)"
               name="course"
         ...
         <div class="col-xs-12 col-sm-4 col-md-4 pdright unidiv"
            id="univdiv">
            <label for="comment">University Choice 1 <span
               class="text-red">*</span></label>
            <select id="universty_choice"
               name="universty_choice"
               class="form-control capitalLetter universty_choice"
               onchange="selectUniversityChoice(this.value)"
               required="true">
               <option value="">Select</option>
               <?php
                  if (count($applicaitonStepOne) > 0) {
                      ...
                      foreach ($statewiseUniversites as $key => $univercity11) {
                          if (count($univercity11) > 0) {
                              $statenames = $this->common_model->getStateById($key);
                              echo '<optgroup label="&nbsp;&nbsp;&nbsp;' . $statenames[0]['name'] . '" class="stt">';
                              foreach ($univercity11 as $uni_choice) {
                                  if (!empty($applicaitonStepOne)) {
                      ...
                      foreach ($centraluniversities as $univercity_cnet1) {
                          if (!empty($applicaitonStepOne)) {
                              if ($applicaitonStepOne[0]['universty_choice'] == $univercity_cnet1['id']) {
                                  echo '<option selected="selected" value="' . $univercity_cnet1['id'] . '">' . $univercity_cnet1['uni'] . '</option>';
                              } else {
                                  echo '<option value="' . $univercity_cnet1['id'] . '">' . $univercity_cnet1['uni'] . '</option>';
                              }
                          } else {
                              echo '<option value="' . $univercity_cnet1['id'] . '">' . $univercity_cnet1['uni'] . '</option>';
                          }
         ...
         <?php
            if ($applicaitonStepOne[0]['programme'] > 0 && $applicaitonStepOne[0]['programme'] == 1 || $applicaitonStepOne[0]['programme'] == 2 || $applicaitonStepOne[0]['programme'] == 4) {
                ...
                if ($applicaitonStepOne[0]['course'] > 0 && $crs[0]['has_stream'] > 0) {
                    ...
                    if ($applicaitonStepOne[0]['course'] > 0 && $crs[0]['has_stream'] > 0) {
            ?>
         <div class="name-sec col-xs-12 col-sm-3 col-md-4 course_option_name"
            id="option_name">
            <label for="comment">Course Stream/Subject 1<span
                     class="text-red">*</span></label>
            <div class="form-group col-md-10 pdleft">
               <select name="course_option_name"
                  id="course_option_name"
                  class="form-control capitalLetter"
                  required="true">
                  <option
                     value="<?php echo $applicaitonStepOne[0]['course_option_name']; ?>">
                     <?php echo $applicaitonStepOne[0]['course_option_name']; ?>
                  </option>
               </select>
            </div>
         </div>
         ...
         <div class="name-sec col-xs-12 col-sm-3 col-md-4  course_option_name"
            id="option_name">
            <label for="comment">Subject 1<span
                     class="text-red">*</span></label>
            <div class="form-group col-md-10 pdleft">
               <select name="course_option_name"
                  id="course_option_name"
         ...
         <?php
            ...
            ?>
         <div class="col-xs-12 col-sm-4 col-md-4 pdleft course_option_name"
            id="option_name">
            <label for="comment"
               title="Course Stream choice 1">Subject 1<span
                     class="text-red">*</span> </label>
            <select name="course_option_name"
               id="course_option_name"
               class="form-control capitalLetter"
         ...
         <?php
            ...
            ?>
         <div class="col-xs-12 col-sm-4 col-md-4 pdright course_option_name"
            id="option_name">
            <label for="comment">Subject 1<span
                     class="text-red">*</span> </label>
            <select name="course_option_name"
      ...
      <div class="formrow dateof-birth unidiv2"
         ...
         <div class="col-xs-12 col-sm-4 col-md-4 pdleft course_wish_study"
            id="course_wish">
            <label for="comment"
               title="Course choice 2">Sub Stream you wish to study 2<span
               class="text-red">*</span></label>
            <select id="course_two"
               onChange="getCourseData2(this.value)"
               name="course_two"
               class="form-control course_two capitalLetter">
               <option value="">Select Sub Stream</option>
               <?php
                  $courses = $this->common_model->getCourseByPrgrammeAndType($applicaitonStepOne[0]['programme'], $applicaitonStepOne[0]['course_type']);
         ...
         <div class="col-xs-12 col-sm-4 col-md-4 pdleft course_wish_study"
            id="course_wish">
            <label for="comment"
               title="Course choice 3">Sub Stream you wish to study 2 <span
               class="text-red">*</span></label>
            <select id="course_two"
               onChange="getCourseData2(this.value)"
               name="course_two"
         ...
         <div class="col-xs-12 col-sm-4 col-md-4 unidiv"
            id="univdiv">
            <label for="comment">University Choice 2<span
               class="text-red">*</span></label>
            <select id="universty_choice_two"
               name="universty_choice_two"
               class="form-control capitalLetter universty_choice"
               onchange="selectUniversityChoice_third(this.value)"
               required="true">
               <option value="">Select</option>
               <?php
                  if (count($applicaitonStepOne) > 0) {
                      echo '<optgroup label="State Universities">';
                      foreach ($stateuniversities as $univercitytwo) {
                          if (array_key_exists($univercitytwo['state_id'], $statewiseUniversitestwo)) {
                              array_push($statewiseUniversitestwo[$univercitytwo['state_id']], $univercitytwo);
                          }
                      }
                      foreach ($statewiseUniversitestwo as $key => $univercity1) {
                      ...
                      echo '</optgroup>';
                      echo '<optgroup label="Central Universities">';
                      foreach ($centraluniversitiestwo as $univercity_cnet) {
                          if (!empty($applicaitonStepOne)) {
                      ...
                      echo '</optgroup>';
                      echo '<optgroup label="National Institute of Technology (NIT)">';
                      foreach ($nitstwo as $univercity_nit) {
                          if (!empty($applicaitonStepOne)) {
         ...
         <?php
            if ($applicaitonStepOne[0]['programme'] > 0 && $applicaitonStepOne[0]['programme'] == 1 || $applicaitonStepOne[0]['programme'] == 2 || $applicaitonStepOne[0]['programme'] == 4) {
                ...
                if ($applicaitonStepOne[0]['course'] > 0 && $crs[0]['has_stream'] > 0) {
                    ...
                    if ($applicaitonStepOne[0]['course'] > 0 && $crs[0]['has_stream'] > 0) {
            ?>
         <div class="name-sec col-xs-12 col-sm-3 col-md-4 course_option_name_two"
            id="option_name">
            <label for="comment">Course Stream/Subject 2<span
                     class="text-red">*</span></label>
            <div class="form-group col-md-10 pdleft">
               <select name="course_option_name_two"
                  id="course_option_name_two"
                  class="form-control capitalLetter"
                  required="true">
                  <option
                     value="<?php echo $applicaitonStepOne[0]['course_option_name_two']; ?>">
                     <?php echo $applicaitonStepOne[0]['course_option_name_two']; ?>
                  </option>
               </select>
            </div>
         </div>
         ...
         <div class="name-sec col-xs-12 col-sm-3 col-md-4 course_option_name_two"
            id="option_name">
            <label for="comment">Subject 2<span
                     class="text-red">*</span></label>
            <div class="form-group col-md-10 pdleft">
               <select name="course_option_name_two"
                  id="course_option_name_two"
         ...
         <?php
            ...
            ?>
         <div class="col-xs-12 col-sm-4 col-md-4 pdleft course_option_name_two"
            id="option_name">
            <label for="comment">Subject 2<span
                     class="text-red">*</span></label>
            <select name="course_option_name_two"
         ...
         <?php
            ...
            ?>
         <div class="col-xs-12 col-sm-4 col-md-4 pdright course_option_name_two"
            id="option_name">
            <label for="comment">Subject 2<span
                     class="text-red">*</span></label>
            <select name="course_option_name_two"
      ...
      <div class="formrow dateof-birth unidiv3"
         ...
         <div class="col-xs-12 col-sm-4 col-md-4 pdleft course_wish_study"
            id="course_wish">
            <label for="comment"
               title="Course choice 3">Sub Stream you wish to study
            3<span class="text-red">*</span></label>
            <select id="course_three"
               onChange="getCourseData3(this.value)"
               name="course_three"
               class="form-control capitalLetter course_three">
               <option value="">Select Sub Stream</option>
               <?php
                  $courses = $this->common_model->getCourseByPrgrammeAndType($applicaitonStepOne[0]['programme'], $applicaitonStepOne[0]['course_type']);
         ...
         <?php
            ...
            } elseif (count($applicaitonStepOne) > 0 && $applicaitonStepOne[0]['programme'] == 3  || $applicaitonStepOne[0]['programme'] == 7 || $applicaitonStepOne[0]['programme'] == 8) {
            ?>
         <div class="col-xs-12 col-sm-4 col-md-4 pdright fade course_wish_study"
            id="course_wish"
            style="display:none;">
         ...
         <div class="col-xs-12 col-sm-4 col-md-4 pdleft course_wish_study"
            id="course_wish">
            <label for="comment">Sub Stream you wish to study 3<span
               class="text-red">*</span></label>
            <select id="course_three"
               onChange="getCourseData3(this.value)"
               name="course_three"
               class="form-control course_three capitalLetter">
               <option value="">Select Sub Stream</option>
            </select>
         </div>
         <?php
         ...
         <div class="col-xs-12 col-sm-4 col-md-4 unidiv"
            id="univdiv">
            <label for="comment">University Choice 3 <span
               class="text-red">*</span></label>
            <select id="universty_choice_three"
               name="universty_choice_three"
               class="form-control capitalLetter universty_choice"
               required="true"
               onchange="selectUniversityChoice_fourth(this.value)">
               <option value="">Select</option>
               <?php
                  if (count($applicaitonStepOne) > 0) {
                      echo '<optgroup label="State Universities">';
                      foreach ($stateuniversities as $univercity) {
                          if (array_key_exists($univercity['state_id'], $statewiseUniversitesthree)) {
                              array_push($statewiseUniversitesthree[$univercity['state_id']], $univercity);
                          }
                      }
                      foreach ($statewiseUniversitesthree as $key => $univercity1) {
                          if (count($univercity1) > 0) {
                              $statenames = $this->common_model->getStateById($key);
                              echo '<optgroup label="&nbsp;&nbsp;&nbsp;' . $statenames[0]['name'] . '" class="stt">';
                              foreach ($univercity1 as $uni_choice) {
                      ...
                      echo '</optgroup>';
                      echo '<optgroup label="Central Universities">';
                      foreach ($centraluniversitiesthree as $univercity_cnet) {
                          if (!empty($applicaitonStepOne)) {
                      ...
                      echo '</optgroup>';
                      echo '<optgroup label="National Institute of Technology (NIT)">';
                      foreach ($nitsthree as $univercity_nit) {
                          if (!empty($applicaitonStepOne)) {
         ...
         <?php
            if ($applicaitonStepOne[0]['programme'] > 0 && $applicaitonStepOne[0]['programme'] == 1 || $applicaitonStepOne[0]['programme'] == 2 || $applicaitonStepOne[0]['programme'] == 4) {
                ...
                if ($applicaitonStepOne[0]['course'] > 0 && $crs[0]['has_stream'] > 0) {
                    ...
                    if ($applicaitonStepOne[0]['course'] > 0 && $crs[0]['has_stream'] > 0) {
            ?>
         <div class="name-sec col-xs-12 col-sm-3 col-md-4 course_option_name_three"
            id="option_name">
            <label for="comment">Subject 3<span
                     class="text-red">*</span></label>
            <div class="form-group col-md-10 pdleft">
               <select name="course_option_name_three"
                  id="course_option_name_three"
                  class="form-control capitalLetter"
                  required="true">
                  <option
                     value="<?php echo $applicaitonStepOne[0]['course_option_name_three']; ?>">
                     <?php echo $applicaitonStepOne[0]['course_option_name_three']; ?>
                  </option>
               </select>
            </div>
         </div>
         ...
         <?php
            ...
            ?>
         <div class="col-xs-12 col-sm-4 col-md-4 course_option_name_three"
            id="option_name">
            <label for="comment">Subject 3<span
                     class="text-red">*</span></label>
            <select name="course_option_name_three"
         ...
         <?php
            ...
            ?>
         <div class="col-xs-12 col-sm-4 col-md-4 pdright course_option_name_three"
            id="option_name">
            <label for="comment">Subject 3<span
                     class="text-red">*</span></label>
            <select name="course_option_name_three"
         ...
         <div class="formrow dateof-birth unidiv4"
            ...
            <div class="formrow dateof-birth unidiv4"
               ...
               <div class="col-xs-12 col-sm-4 col-md-4 pdleft course_wish_study"
                  id="course_wish">
                  <label for="comment"
                     title="Course choice 4">Sub Stream you wish
                  to study 4</label>
                  <select id="course_fourth"
                     onChange="getCourseData4(this.value)"
                     name="course_fourth"
                     class="form-control course_fourth capitalLetter">
                     <option value="">Select Sub Stream</option>
                     <?php
                        $courses = $this->common_model->getCourseByPrgrammeAndType($applicaitonStepOne[0]['programme'], $applicaitonStepOne[0]['course_type']);
               ...
               <div class="col-xs-12 col-sm-4 col-md-4 pdleft course_wish_study"
                  id="course_wish">
                  <label for="comment">Sub Stream you wish to
                  study 4</label>
                  <select id="course_fourth"
                     onChange="getCourseData4(this.value)"
                     name="course_fourth"
               ...
               <?php
                  ...
                  ?>
               <div class="col-xs-12 col-sm-4 col-md-4 fade course_wish_study"
                  id="course_wish"
                  style="display:none;">
                  <label for="comment">Sub Stream you wish to
                  study 4</label>
               ...
               <div class="col-xs-12 col-sm-4 col-md-4 pdright unidiv"
                  id="univdiv">
                  <label for="comment">University Choice 4</label>
                  <select id="universty_choice_fourth"
                     name="universty_choice_fourth"
                     class="form-control capitalLetter universty_choice"
                     onchange="selectUniversityChoice_fifth(this.value)">
                     <option value="">Select</option>
                     <?php
                        if (count($applicaitonStepOne) > 0) {
                            echo '<optgroup label="State Universities">';
                            foreach ($stateuniversities as $univercity) {
                                if (array_key_exists($univercity['state_id'], $statewiseUniversitesfour)) {
                                    array_push($statewiseUniversitesfour[$univercity['state_id']], $univercity);
                                }
                            }
                            foreach ($statewiseUniversitesfour as $key => $univercity1) {
                                if (count($univercity1) > 0) {
                                    $statenames = $this->common_model->getStateById($key);
                                    echo '<optgroup label="&nbsp;&nbsp;&nbsp;' . $statenames[0]['name'] . '" class="stt">';
                                    foreach ($univercity1 as $uni_choice) {
                            ...
                            echo '</optgroup>';
                            echo '<optgroup label="Central Universities">';
                            foreach ($centraluniversitiesfour as $univercity_cnet) {
                                if (!empty($applicaitonStepOne)) {
                            ...
                            echo '</optgroup>';
                            echo '<optgroup label="National Institute of Technology (NIT)">';
                            foreach ($nitsfour as $univercity_nit) {
                                if (!empty($applicaitonStepOne)) {
               ...
               <?php
                  ...
                  if ($applicaitonStepOne[0]['course'] > 0 && $crs[0]['has_stream'] > 0) {
                  ?>
               <div class="name-sec col-xs-12 col-sm-3 col-md-4 course_option_name_fourth"
                  id="option_name">
                  <label for="comment">Subject 4</label>
                  <div class="form-group col-md-10 pdleft">
                     <select name="course_option_name_fourth"
                        id="course_option_name_fourth"
                        class="form-control capitalLetter"
                        required="true">
                        <option
                           value="<?php echo $applicaitonStepOne[0]['course_option_name_fourth']; ?>">
                           <?php echo $applicaitonStepOne[0]['course_option_name_fourth']; ?>
                        </option>
                     </select>
               ...
               <?php
                  ...
                  ?>
               <div class="col-xs-12 col-sm-4 col-md-4 pdleft course_option_name_fourth"
                  id="option_name">
                  <label for="comment">Subject 4</label>
                  <select name="course_option_name_fourth"
                     id="course_option_name_fourth"
               ...
               <?php
                  ...
                  ?>
               <div class="col-xs-12 col-sm-4 col-md-4 pdright course_option_name_fourth"
                  id="option_name">
                  <label for="comment">Subject 4</label>
                  <select name="course_option_name_fourth"
                     id="course_option_name_fourth"
               ...
               <div class="col-xs-12 col-sm-12 col-md-12 dateof-birth unidiv5"
                  ...
                  <div class="formrow dateof-birth unidiv5"
                     ...
                     <div class="col-xs-12 col-sm-4 col-md-4 pdleft course_wish_study"
                        id="course_wish">
                        <label for="comment"
                           title="Course choice 5">Sub Stream
                        you wish to study 5</label>
                        <select id="course_fifth"
                           onChange="getCourseData5(this.value)"
                           name="course_fifth"
                           class="form-control course_fifth capitalLetter">
                           <option value="">Select Sub Stream
                           </option>
                           <?php
                              $courses = $this->common_model->getCourseByPrgrammeAndType($applicaitonStepOne[0]['programme'], $applicaitonStepOne[0]['course_type']);
                     ...
                     <div class="col-xs-12 col-sm-4 col-md-4 course_wish_study"
                        id="course_wish">
                        <label for="comment">Sub Stream you wish
                        to study 5</label>
                        <select id="course_fifth"
                           onChange="getCourseData5(this.value)"
                           name="course_fifth"
                     ...
                     <div class="col-xs-12 col-sm-4 col-md-4 unidiv"
                        id="univdiv">
                        <label for="comment">University Choice 5</label>
                        <select id="universty_choice_fifth"
                           name="universty_choice_fifth"
                           class="form-control capitalLetter universty_choice"
                           onchange="selectUgUniversityChoiceFifth(this.value)">
                           <option value=" ">Select</option>
                           <?php
                              if (count($applicaitonStepOne) > 0) {
                                  echo '<optgroup label="State Universities">';
                                  foreach ($stateuniversities as $univercity) {
                                      if (array_key_exists($univercity['state_id'], $statewiseUniversitesfive)) {
                                          array_push($statewiseUniversitesfive[$univercity['state_id']], $univercity);
                                      }
                                  }
                                  foreach ($statewiseUniversitesfive as $key => $univercity1) {
                                      if (count($univercity1) > 0) {
                                          $statenames = $this->common_model->getStateById($key);
                                          echo '<optgroup label="&nbsp;&nbsp;&nbsp;' . $statenames[0]['name'] . '" class="stt">';
                                          foreach ($univercity1 as $uni_choice) {
                                  ...
                                  echo '</optgroup>';
                                  echo '<optgroup label="Central Universities">';
                                  foreach ($centraluniversitiesfive as $univercity_cnet) {
                                      if (!empty($applicaitonStepOne)) {
                                  ...
                                  echo '</optgroup>';
                                  echo '<optgroup label="National Institute of Technology (NIT)">';
                                  foreach ($nitsfive as $univercity_nit) {
                                      if (!empty($applicaitonStepOne)) {
                     ...
                     <?php
                        if ($applicaitonStepOne[0]['programme'] > 0 && $applicaitonStepOne[0]['programme'] == 1 || $applicaitonStepOne[0]['programme'] == 2 || $applicaitonStepOne[0]['programme'] == 4) {
                            ...
                            if ($applicaitonStepOne[0]['course_fifth'] > 0 && $crs[0]['has_stream'] > 0) {
                                ...
                                if ($applicaitonStepOne[0]['course'] > 0 && $crs[0]['has_stream'] > 0) {
                        ?>
                     <div class="name-sec col-xs-12 col-sm-3 col-md-4 course_option_name_fifth"
                        id="option_name">
                        <label for="comment">Subject 5</label>
                        <div
                           class="form-group col-md-10 pdleft">
                           <select
                              name="course_option_name_fifth"
                              id="course_option_name_fifth"
                              class="form-control capitalLetter">
                              <option
                                 value="<?php echo $applicaitonStepOne[0]['course_option_name_fifth']; ?>">
                                 <?php echo $applicaitonStepOne[0]['course_option_name_fifth']; ?>
                              </option>
                           </select>
                     ...
                     <?php
                        ...
                        ?>
                     <div class="col-xs-12 col-sm-4 col-md-4 course_option_name_fifth"
                        id="option_name">
                        <label for="comment">Subject 5</label>
                        <select name="course_option_name_fifth"
                           id="course_option_name_fifth"
                           class="form-control capitalLetter">
                           <option
                              value="<?php echo $applicaitonStepOne[0]['course_option_name_fifth']; ?>">
                     ...
                     <?php
                        ...
                        ?>
                     <div class="col-xs-12 col-sm-4 col-md-4 pdright course_option_name_fifth"
                        id="option_name">
                        <label for="comment">Subject 5</label>
                        <select name="course_option_name_fifth"
                           id="course_option_name_fifth"
