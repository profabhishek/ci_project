...
<section class="meacontent">	
	<div class="col-xs-10 form_head">		
		...
		<h3 class="text-center caps">Application Form(2019-2020) For Scholarship through ICCR</h3>
...
<?php
				...
				<div class="col-xs-12 col-sm-7 col-md-12 contact-detail">
					<label>7. Contact Details <span class="text-red">*</span><!--<span class="note"><strong>Note:</strong> (Telephone Number With Country Code eg. : 91 for India)</span>--></label>
				...
				<div class="name-sec col-xs-12 col-sm-5 col-md-7">
					<h4><strong>Details of Father/Guardian <span class="text-red">*</span></strong></h4>
				</div>
              ...
              <div class="addres-sec col-xs-9 col-sm-9 col-md-4 pdleft pdright">	
                ...
                <div class="name-sec col-xs-12 col-sm-6 col-md-4">
				 ...
				 ?>
				 	...
				 	<div class="dateof-birth col-xs-12 col-sm-12 col-md-12 pdleft pdright">						
					<div class="name-sec col-xs-12 col-sm-3 col-md-4">
					 <label for="comment">9. Level of Programme <span class="text-red">*</span></label>
...
<div class="dateof-birth col-xs-12 col-sm-12 col-md-12 pdleft pdright">						
				...
				<!--<div class="name-sec col-xs-4 col-sm-2 col-md-3 pull-right">				
				 ...
				 <input type="submit" id="step-one-application" name="step-one-application" class="form-control btn btn-info sbmt" value="Next >>"/>
