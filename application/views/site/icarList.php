...
<section class="meacontent" id="meacontent">
   <div  class="container">
      ...
      <ul class="list-group" label="ICAR Empannelled Universities">
            <h1>ICAR Empannelled Universities</h1>
           <?php $centraluniversities = $this->common_model->getAgriculturalUniversity();	?>
