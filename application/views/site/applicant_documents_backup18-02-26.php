	...
	<div class="container" style="min-height:380px;padding:0px;">
		...
		<div class="tab-content">
			...
			<div id="step3" class="tab-pane fade in active">
				<h5 class="text-center">Please Upload All Documents Listed Below <br/><span style="color:red;">Note: (All document should be in PDF format) <br /> All file names should be in english language like (Physical Fitness.pdf..etc.) not in other language like:-> غفران_الحلبي_كشف.pdf.
						<br />
							...
							<table class="table">
								...
								if (file_exists($file)) {
									...
									<tr>
										<td><?php echo $counter;
											$counter++; ?></td>
										<td>Permanent Unique ID <span style="color:red;font-size:11px;">(Document size must be less than 1 MB)</span><span class="text-red">*</span></td>
										<td>
											<?php
									...
									<tr>
										...
										<td><?php echo $counter;
											$counter++; ?></td>
										<!---<td><?php echo $doctypes['tl']['title']; ?> <span class="text-red">*</span> &nbsp;<b>(Compulsury) If you have any translation document please upload. </b></td>-->
						...
						<div class="passport-sec col-xs-12 col-sm-12 col-md-12 pdleft pdright">
							<div class="name-sec col-xs-12 col-sm-6 col-md-12">
								<div class="form-group">
									...
									<span class=""><input type="checkbox" id="" name="undertaking" class="" required onchange="notification();" /> &nbsp;<b>i.&nbsp; READ all the ICCR Terms and Conditions and New SOPs.</b></span> <br />
									<span class=""><input type="checkbox" id="" name="undertaking" class="" required onchange="notification();" /> &nbsp;<b>ii.&nbsp; All the Entries/Information filled is correct and will be solely responsible the consequences if any of provided Information is found Incorrect or have applied more than once.<b></span>
