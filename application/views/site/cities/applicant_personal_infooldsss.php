...
<section class="meacontent">	
	<div class="col-xs-10 form_head">		
		...
		<h3 class="text-center caps">Application Form(2020-2021) For Scholarship through ICCR</h3>
...
<?php
				...
				<div class="addres-sec col-xs-9 col-sm-9 col-md-12 pdright">	
					 <label for="comment">Permanent Unique ID  (Excluding Passport No.)<span class="text-red">*</span></label>
						<div class="form-group col-md-4 pdleft">
              ...
              <div class="addres-sec col-xs-9 col-sm-9 col-md-4 pdleft pdright">	
                ...
                <div class="name-sec col-xs-12 col-sm-6 col-md-4">
				 ...
				 ?>
				 	...
				 	<div class="dateof-birth col-xs-12 col-sm-12 col-md-12 pdleft pdright">						
					<div class="name-sec col-xs-12 col-sm-3 col-md-4">
					 <label for="comment">9. Level of Programme latest<span class="text-red">*</span></label>
...
<div class="dateof-birth col-xs-12 col-sm-12 col-md-12 pdleft pdright">						
				...
				if(count($applicaitonStepOne)<=0 || count($applicaitonStepOne)>0)
				{
					...
					else
					{
						?>
						<div class="name-sec col-xs-12 col-sm-3 col-md-4 course_wish_study">
						 	<label for="comment">course you wish to study 1 latest<span class="text-red">*</span></label>
							<div class="form-group col-md-10 pdleft">
					...
					else
					{
						?>
						<div class="name-sec col-xs-12 col-sm-3 col-md-4 unidiv">
						 <label for="comment">University 1 latest</label>
					<div class="form-group col-md-10 pdleft">		
					<?php
				...
				if(count($applicaitonStepOne)>0 && $applicaitonStepOne[0]['programme'] != 3 && $applicaitonStepOne[0]['programme'] != 4 && $applicaitonStepOne[0]['programme'] != 7 && $applicaitonStepOne[0]['programme'] != 8)
					...
					else
					{
						?>
						<div class="name-sec col-xs-12 col-sm-3 col-md-4 course_wish_study">
						 	<label for="comment">course you wish to study 2 latest<span class="text-red">*</span></label>
							<div class="form-group col-md-10 pdleft">
				...
				if(count($applicaitonStepOne)>0 && $applicaitonStepOne[0]['programme'] != 3 && $applicaitonStepOne[0]['programme'] != 4 && $applicaitonStepOne[0]['programme'] != 7 && $applicaitonStepOne[0]['programme'] != 8)
					...
					else
					{
						?>
						<div class="name-sec col-xs-12 col-sm-3 col-md-4 unidiv">
						 <label for="comment">University 3 latest not draft</label>
					<div class="form-group col-md-10 pdleft">
						<?php
							$user_data = $this->session->userdata('user_data');
							$student_type = $user_data['student_type'];	
			...
			if(count($applicaitonStepOne)>0 && $applicaitonStepOne[0]['programme'] != 3 && $applicaitonStepOne[0]['programme'] != 4 && $applicaitonStepOne[0]['programme'] != 7 && $applicaitonStepOne[0]['programme'] != 8)
				...
				<div class="name-sec col-xs-12 col-sm-3 col-md-4 unidiv">
						 <label for="comment">University 4 latest not draft</label>
					<div class="form-group col-md-10 pdleft">		
				...
				{
					?>
					 <select id="universty_choice_fourth" name="universty_choice_fourth"  class="form-control universty_choice_cl" onchange="selectAyushUniversityChoice(this.value)" required="true">
					<?php
				}
				else
				{
					...
					<?php
						...
						<!----<select id="universty_choice_fourth" name="universty_choice_fourth" class="form-control" required="true">--->					 
						 	<option value="">Select</option>							 								 	
						 </select>
			...
			?>
											...
											<div class="name-sec col-xs-12 col-sm-3 col-md-4 course_option_name_fourth" style="display:none;">
						 <label for="comment">Course Stream 4 latest</label>
							<div class="form-group col-md-10 pdleft">
							<select id="course_option_name_fourth" name="course_option_name_fourth" class="form-control">						 	
							  	<option value="">Select Course</option>								  					 	
							 </select>
							  <!----<input type="text" name="course_option_name_three" id="course_option_name_fourth" placeholder="Subject" class="form-control">---->
							</div>
						</div>
			...
			<!---------University 5 START HERE----------->	
				...
				?>
						...
						<div class="name-sec col-xs-12 col-sm-3 col-md-4 course_option_name_fifth" style="display:none;">
						 <label for="comment">Course Stream 5 not draft</label>
							<div class="form-group col-md-10 pdleft">
							<select id="course_option_name_fifth" name="course_option_name_fifth" class="form-control">						 	
							  	<option value="">Select Course</option>								  					 	
							 </select>
							  <!----<input type="text" name="course_option_name_fifth" id="course_option_name_fifth" placeholder="Subject" class="form-control">--->
							</div>
						</div>
