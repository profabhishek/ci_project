...
<section class="meacontent">	
	<div class="col-xs-10 form_head">		
		...
		<h4 class="text-center caps">FRRO Details of Applicant</h4>
	</div>
	...
	<div class="blue-heading col-md-12 ">
			 <h3>FRRO Details</h3>	
			 <?php
			 if(count($frroDetails)<=0)
			 {
			 	?>
			 	 <a class="form-control lnk"  href="<?php echo site_url();?>applicant/addFRRODetails/<?php echo $this->uri->segment(3);?>">Add FRRO Details</a>
			 	<?php
			 }
			 ?>	
              	...
              	<div class="passport-sec col-xs-12 col-sm-12 col-md-12 pdleft pdright">
					<table class="table">
						...
						<tbody>	
							...
							{
								$counter = 1;
								foreach($frroDetails as $frro)
								{
									?>
									<tr>
										<td><?php echo $counter;?></td>
										<td><?php echo $this->common_model->getRegionById();?></td>
										<td><?php $c = $this->common_model->getComplaintCatById($frro['category']); echo $c[0]['category'];?></td>
										<td><?php echo $frro['descripton'];?></td>
