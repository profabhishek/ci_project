...
<section class="meacontent">	
	<div class="col-xs-10 form_head">		
		...
		<h3 class="text-center caps">Student Registration(2021-2022) for ICCR Scholarship Programme</h3>
...
<div class="container" style="padding:0;min-height: 396px;">
	  ...
	  <!-- general form elements -->
          <div class="box  col-xs-6">            
            <!-- /.box-header -->
            <!-- form start -->
           <form id="identicalForm" action="<?php echo site_url();?>user/register" onsubmit="return validate_registration();" enctype="multipart/form-data" method="post"  data-fv-framework="bootstrap"
    data-fv-icon-valid="glyphicon glyphicon-ok" data-fv-icon-invalid="glyphicon glyphicon-remove" data-fv-icon-validating="glyphicon glyphicon-refresh">
              <div class="box-body">
                ...
                <select class="form-control select2" name="apply_course_type" id="apply_course_type" style="width: 100%;" required="true">                  
				  ...
				  // <option value = "1">UG(Under all Scholarship Schemes for ICCR)</option>
				     <option value = "2">PG(Under all Scholarship Schemes for ICCR)</option>
                   <option value = "4">Ph.D(Under all Scholarship Schemes for ICCR)</option>
				   <option value = "3">M.Phil(Under all Scholarship Schemes for ICCR)</option>
				   <option value = "5">Dance and Music(with Gurus)</option>
				   <!----<option value = "6">Music (with Guru's)</option>--->
				   <option value = "9">Cetificate/Diploma Course</option>//
				   <!-----<option value = "2">Ayush Scholarship Scheme(UG/PG/PHD in Ayuerveda,Yoga,Unani,Siddha and Homoeopathy)</option>	  
				   <option value = "3">SFS(Self Finance Student) Under Ayush Scholarship Scheme</option>--->
                </select>
                </div>             
              </div>
						<div class="name-sec col-xs-12 col-sm-3 col-md-2">
                  ...
                  <option value="">Select</option>
                   <?php
						  ...
						  $countries_new = $this->common_model->getCountriesById();
						  foreach($countries_new as $country)
						  {
						  	if($country['id'] != 166)
						  	{
