    ...
    <div class="card1 hovercard">
        ...
        <div class="card-info"> <span class="card-title">
        				<?php $title = '';									
						  ...
						  {
						  	$title = $registerSfsData[0]['username'];
						  }												  
					  ?>
					  <?php if(!empty($registerSfsData)) echo $registerSfsData[0]['username'];?></span>
        ...
        <div class="tab-pane fade in active" id="tab1" style="overflow:hidden;">        
          <div class="dateof-birth col-xs-12 col-sm-12 col-md-12 pdleft pdright">	
					...
					<div class="dateof-birth col-xs-12 col-sm-12 col-md-12 pdleft pdright">	
						 ...
						 <label for="comment"> Date of Birth: </label><?php if(!empty($registerSfsData)) echo $registerSfsData[0]['date_of_birth'];?>							
					...
					<div class="dateof-birth col-xs-12 col-sm-12 col-md-12 pdleft pdright">	
					 ...
					 <label> Country of Residence:  </label><?php //echo "<pre>";print_r($applicaitonSfsStepOne);die;
						  $nationalities = $this->common_model->getCountries();
						  foreach($nationalities as $nationality)
						  {
						  	if(!empty($registerSfsData))
						  	{
								if($registerSfsData[0]['country_of_domicile'] == $nationality['id'])
								{
									echo $nationality['country_name'];
								}								
							}
        ...
        <div class="tab-pane fade in" id="tab2" style="overflow:hidden;">
          <div class="col-xs-12 col-sm-7 col-md-12 contact-detail">
			<label>Mobile Number:</label>
			 ...
			 <?php if(!empty($registerSfsData)) echo $registerSfsData[0]['mobile_number'];?>
				
		  </div>
		  <div class="addres-sec col-xs-9 col-sm-9 col-md-12 pdright">
			<label>Email Id: </label>	
			 <?php if(!empty($registerSfsData)) echo $registerSfsData[0]['email_id'];?>
			</div>
        </div>
          ...
          <div class="addres-sec col-xs-9 col-sm-9 col-md-4 pdleft pdright">	
					<div class="name-sec col-xs-12 col-sm-6 col-md-12">
						<label for="comment"> Postal Address </label>	
						  ...
						  <?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['postal_address'];?><br/>
						  City :<?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['postal_address_city'];?><br/>
						  State: <?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['postal_address_state'];?><br/>
						  Country:  <?php
						  ...
						  ?>
						  <br/>
						  Pincode: <?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['postal_address_pincode'];?>
					</div>
