...
<section class="meacontent">	
	...
	<form method="post" action="<?php echo base_url();?>sfs/downloadApplication/<?php echo $this->uri->segment(3); ?>" enctype="multipart/form-data" id="frm_details_ngo" name="frm_details_ngo" style="width: 100%;position: relative;top: -43px;
">
              ...
              <div class="box-body">
              	<div class="col-xs-3 prfl pull-right" >
              		<?php 
						...
						$dir = '/assets/'.$user_data['dir'].'/'. $userImage.'/v';
						...
						else
						{
							...
							{
								?>
								<img style="width:151px;height:171px;" id="profil_image_div" src="<?php echo site_url();?><?php echo $user_data['dir'].'/'. $userImage; ?>"/>
								<?php	
							}		
						}
              	...
              	<div class="name-sec col-xs-12 col-sm-9 col-md-9 pdleft pdright">
					<table id="fbl_main" style="width: 100%;">
					  ...
					  ?>	
					   <?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['fullname'];?>	</td>
							</tr>
							<tr >
						  ...
						  if(count($applicaitonSfsStepOne) > 0)
						  {
						  	$title = $applicaitonSfsStepOne[0]['gender'];
						  }
						  if($title == 1)
						  {
						  	echo 'Male';					  	
					  ...
					  ?></td>
							...
							<tr>
								...
								<label>3. Date of Birth</label></td>
											<td>:&nbsp;&nbsp;<?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['dob'];?>
						  ...
						  foreach($nationalities as $na)
						  {
						  	...
						  	{
								if($applicaitonSfsStepOne[0]['nationality'] == $na['id'])
								{
						  ...
						  ?></td>
							...
							<tr>
								...
								<td style="height:35px;">:&nbsp;&nbsp;<?php if(!empty($applicaitonSfsStepOne)) if($applicaitonSfsStepOne[0]['passport_no'] != "") echo $applicaitonSfsStepOne[0]['passport_no']; else echo "NA";?></td>
							</tr>
							<tr>
								...
								<table id="tblpassport" class="table" style="width: 100%;">
									...
									<tbody>
										<tr>
											<td><?php if(!empty($applicaitonSfsStepOne)) if($applicaitonSfsStepOne[0]['passport_issue_date'] != "") echo $applicaitonSfsStepOne[0]['passport_issue_date']; else echo "NA"; ?></td>
											<td><?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['passport_expiry_date']; ?></td>
											<td ><?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['passport_issue_place'];?></td>
										</tr>
									</tbody>
								</table>
							...
							<tr>
								...
								<td>:&nbsp;&nbsp;<?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['postal_address'];?></td>	
							...
							<td colspan="2">
								<table id="tblpassport" class="table" style="width: 100%;">
									...
									<tbody>
										<tr>
											<td><?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['postal_address_city'];?></td>
											<td><?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['postal_address_state'];?></td>
											<td ><?php
											  $countries = $this->common_model->getCountries();
											  foreach($countries as $country)
											  {
											  ...
											  ?></td>
											  <td><?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['postal_address_pincode'];?></td>
										</tr>
									</tbody>
								</table>
								</td>
							...
							<tr>
								...
								<td style="height:35px;">:&nbsp;&nbsp;+<?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['tel_country_code'];?>&nbsp;&nbsp;<?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['phone'];?></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td style="height:35px;">
									:&nbsp;&nbsp;<?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['unique_id'];?>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<table id="tbl_father" class="table" style="width:100%;">
									...
									<tbody>
										<tr>
											<td ><?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['guardian_name'];?>	 </td>
											<td><?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['guardian_relation'];?></td>
											<td><?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['guardian_occupation'];?></td>
											<td><?php
									  $nationalities = $this->common_model->getCountries();
									  foreach($nationalities as $na)
									  {
							...
							<tr>
								...
								<td>:&nbsp;&nbsp;<?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['guardian_address'];?></td>
							</tr>
							<tr>
								<td colspan="2">
									<table id="tbl_gaurdian" style="width: 100%;">
										...
										<tbody>
											<td><?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['gardiuan_address_city'];?></td>
											<td><?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['gardiuan_address_state'];?></td>
											<td><?php
								  $countries = $this->common_model->getCountries();
								  foreach($countries as $country)
								  {
								  ...
								  ?></td>
								  <td><?php if(!empty($applicaitonSfsStepOne)) echo $applicaitonSfsStepOne[0]['gardiuan_address_pincode'];?></td>
										</tbody>
									</table>
								</td>
							</tr>
								...
								<table style="width:100%;" id="tbl_course">
									<thead>
										<th>9. Level of Programme</th>
											  		<?php 
					if(count($applicaitonSfsStepOne)>0 && $applicaitonSfsStepOne[0]['programme'] == 1 || $applicaitonSfsStepOne[0]['programme'] == 2 || $applicaitonSfsStepOne[0]['programme'] == 9)
					{
						...
						elseif(count($applicaitonSfsStepOne)>0 && $applicaitonSfsStepOne[0]['programme'] == 3 || $applicaitonSfsStepOne[0]['programme'] == 4 || $applicaitonSfsStepOne[0]['programme'] == 8)
					{
						?>
					...
					if(count($applicaitonSfsStepOne)>0 && $applicaitonSfsStepOne[0]['programme'] == 1 || $applicaitonSfsStepOne[0]['programme'] == 2 || $applicaitonSfsStepOne[0]['programme'] == 3 || $applicaitonSfsStepOne[0]['programme'] == 4 || $applicaitonSfsStepOne[0]['programme'] == 9)
					{
						...
						$courseType = $this->common_model->getAllCourseType();
							...
							if($applicaitonSfsStepOne[0]['programme'] == 3 || $applicaitonSfsStepOne[0]['programme'] == 4)
							{
								echo $applicaitonSfsStepOne[0]['course_subject'];
							}		
						}
						elseif(count($applicaitonSfsStepOne)>0 && $applicaitonSfsStepOne[0]['programme'] == 8)
					{
						echo $applicaitonSfsStepOne[0]['course_subject'];
					}	
						?>
							...
							<tr>
								<td colspan="3">
									<?php
									if(count($applicaitonSfsStepOne)>0 && $applicaitonSfsStepOne[0]['programme'] != 3 && $applicaitonSfsStepOne[0]['programme'] != 4 && $applicaitonSfsStepOne[0]['programme'] != 7 && $applicaitonSfsStepOne[0]['programme'] != 8)
					{
						?>
						<table id="tbl_uni" style="width: 100%;">
										...
										<tbody>
											<tr>
												<td>
												<?php
						if($applicaitonSfsStepOne[0]['programme'] == 1 || $applicaitonSfsStepOne[0]['programme'] == 2)
						{
							
					  		$courses = $this->common_model->getCourseByPrgrammeAndType($applicaitonSfsStepOne[0]['programme'],$applicaitonSfsStepOne[0]['course_type']);
					  		
					  		foreach($courses as $course)
					  		{
								if(!empty($applicaitonSfsStepOne))
							  	{
							  		if($applicaitonSfsStepOne[0]['course'] == $course['id'])
							  		{
										echo $course['title'];
									}
								}
						...
						elseif($applicaitonSfsStepOne[0]['programme'] == 5 || $applicaitonSfsStepOne[0]['programme'] == 6)
						{
							$courses = $this->common_model->getCourseByPrgramme($applicaitonSfsStepOne[0]['programme']);
					  		foreach($courses as $course)
					  		{
								if(!empty($applicaitonSfsStepOne))
							  	{
						...
						elseif($applicaitonSfsStepOne[0]['programme'] == 9)
						{
						...
						?>	
												...
												<td><?php $university_second =  $this->common_model->getUniversityById($applicaitonSfsStepOne[0]['universty_choice']);echo $university_second[0]['name'];?></td>
												<td><?php
												if($applicaitonSfsStepOne[0]['programme'] > 0 && $applicaitonSfsStepOne[0]['programme'] == 1 ||  $applicaitonSfsStepOne[0]['programme'] == 2 ||  $applicaitonSfsStepOne[0]['programme'] == 4)
						{
							$crs = $this->common_model->getCoursesById($applicaitonSfsStepOne[0]['course']);
							if($applicaitonSfsStepOne[0]['course'] > 0 && $crs[0]['has_stream'] > 0)
							{
								if(!empty($applicaitonSfsStepOne)) 
								echo $applicaitonSfsStepOne[0]['course_option_name'];
							}	
							else
							{
								echo "NA";
						...
						if($applicaitonSfsStepOne[0]['programme'] == 1 || $applicaitonSfsStepOne[0]['programme'] == 2)
						{
					  		...
					  		foreach($courses as $course)
					  		{
								if(!empty($applicaitonSfsStepOne))
							  	{
							  		if($applicaitonSfsStepOne[0]['course_two'] == $course['id'])
							  		{
										echo $course['title'];
									}
								}
						...
						?></td>
												<td><?php $university_second =  $this->common_model->getUniversityById($applicaitonSfsStepOne[0]['universty_choice_two']);echo $university_second[0]['name'];?></td>
												<td><?php
												if($applicaitonSfsStepOne[0]['programme'] > 0 && $applicaitonSfsStepOne[0]['programme'] == 1 ||  $applicaitonSfsStepOne[0]['programme'] == 2 ||  $applicaitonSfsStepOne[0]['programme'] == 4)
						{
							$crs = $this->common_model->getCoursesById($applicaitonSfsStepOne[0]['course']);
							if($applicaitonSfsStepOne[0]['course_two'] > 0 && $crs[0]['has_stream'] > 0)
							{
								if(!empty($applicaitonSfsStepOne)) 
								echo $applicaitonSfsStepOne[0]['course_option_name_two'];
							}	
							else
							{
								echo "NA";
						...
						if($applicaitonSfsStepOne[0]['programme'] == 1 || $applicaitonSfsStepOne[0]['programme'] == 2)
						{
					  		...
					  		foreach($courses as $course)
					  		{
								if(!empty($applicaitonSfsStepOne))
							  	{
							  		if($applicaitonSfsStepOne[0]['course_three'] == $course['id'])
							  		{
										echo $course['title'];
									}
								}
						...
						?></td>
												<td><?php $university_second =  $this->common_model->getUniversityById($applicaitonSfsStepOne[0]['universty_choice_three']);echo $university_second[0]['name'];?></td>
												<td><?php
												if($applicaitonSfsStepOne[0]['programme'] > 0 && $applicaitonSfsStepOne[0]['programme'] == 1 ||  $applicaitonSfsStepOne[0]['programme'] == 2 ||  $applicaitonSfsStepOne[0]['programme'] == 4)
						{
							$crs = $this->common_model->getCoursesById($applicaitonSfsStepOne[0]['course']);
							if($applicaitonSfsStepOne[0]['course_three'] > 0 && $crs[0]['has_stream'] > 0)
							{
								if(!empty($applicaitonSfsStepOne)) 
								echo $applicaitonSfsStepOne[0]['course_option_name_three'];
							}	
							else
							{
								echo "NA";
					...
					else
					{
						...
						<table id="tbl_uni" style="width: 100%;">
										...
										<tbody>
											<tr>
												<td><?php $university_first = $this->common_model->getUniversityById($applicaitonSfsStepOne[0]['universty_choice']); echo $university_first[0]['name'];?></td>
												<td><?php $university_second =  $this->common_model->getUniversityById($applicaitonSfsStepOne[0]['universty_choice_two']);echo $university_second[0]['name'];?></td>
												<td><?php $university_three = $this->common_model->getUniversityById($applicaitonSfsStepOne[0]['universty_choice_three']); echo $university_three[0]['name'];?></td>
											</tr>
										</tbody>
									</table>
						<?php
...
<div class="box-body">  
					...
					<table id="tbl_edu" class="table" style="width:100%;">
						...
						<tbody>
							...
							switch($program)
							{
								...
								<td >
								  <?php if(!empty($applicaitonSfsStepTwo)) echo $applicaitonSfsStepTwo[0]['school_leaving_university'];?>
								</td>
								<td >
									<?php if(!empty($applicaitonSfsStepTwo)) echo $applicaitonSfsStepTwo[0]['school_leaving_year'];?>
								</td>
								<td >
									<?php if(!empty($applicaitonSfsStepTwo)) echo $applicaitonSfsStepTwo[0]['school_leaving_percentage'];?>
								</td>
							</tr>
								<?php
								break;
							...
							<tr>
								...
								<td >
								  <?php if(!empty($applicaitonSfsStepTwo)) echo $applicaitonSfsStepTwo[0]['ug_leaving_university'];?>
								</td>
								<td>
									<?php if(!empty($applicaitonSfsStepTwo)) echo $applicaitonSfsStepTwo[0]['ug_leaving_year'];?>
								</td>
								<td >
									<?php if(!empty($applicaitonSfsStepTwo)) echo $applicaitonSfsStepTwo[0]['ug_leaving_percentage'];?>
								</td>
							</tr>
								<?php
								break;
							...
							<td>Post graduate<br/>(Two years University education after graduation or five years after class XII.)</td>
								...
								<td >
								 <?php if(!empty($applicaitonSfsStepTwo)) echo $applicaitonSfsStepTwo[0]['pg_leaving_university'];?>
								</td>
								<td>
									<?php if(!empty($applicaitonSfsStepTwo)) echo $applicaitonSfsStepTwo[0]['pg_leaving_year'];?>
								</td>
								<td >
									<?php if(!empty($applicaitonSfsStepTwo)) echo $applicaitonSfsStepTwo[0]['pg_leaving_percentage'];?>
								</td>
							</tr>
								<?php
								break;
				...
				<?php 
				if(!empty($applicaitonSfsStepTwo) && $applicaitonSfsStepTwo[0]['other_course_year'] != "" && $applicaitonSfsStepTwo[0]['other_course_university'] != "" && $applicaitonSfsStepTwo[0]['other_course'] != "") 
				{
				?>
				<div class="passport-sec col-xs-12 col-sm-12 col-md-12 pdleft pdright">
				...
				<div class="passport-sec col-xs-12 col-sm-12 col-md-12 pdleft pdright">
					<table id="tbl_optional" class="table" style="width:100%;">
						...
						<tbody>
							<tr>
								<td><?php if(!empty($applicaitonSfsStepTwo)) echo $applicaitonSfsStepTwo[0]['other_course_year'];?></td>
								<td><?php if(!empty($applicaitonSfsStepTwo)) echo $applicaitonSfsStepTwo[0]['other_course_university'];?></td>
								<td><?php if(!empty($applicaitonSfsStepTwo)) echo $applicaitonSfsStepTwo[0]['other_course'];?></td>							
							</tr>							
						</tbody>
					</table>
				</div>
				...
				<thead>
					...
					<tbody>
					<tr>
										<td> <?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['enq_ref_one_name'];?></td>
										<td>
											<?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['enq_ref_one_designation'];?>
										</td>
										<td> <?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['enq_ref_one_email'];?> </td>
										<td> <?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['enq_ref_one_phone'];?></td>
										<td colspan="2"><?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['enq_ref_one_address'];?></td>
									</tr>
						<tr>
				...
				<table style="width:100%;" id="tbl_ref2" class="table">
					...
					<tbody>
						<tr>
							<td><?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['enq_ref_two_name'];?></td>
							<td><?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['enq_ref_two_designation'];?></td>
							<td><?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['enq_ref_two_email'];?> </td>
							<td><?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['enq_ref_two_phone'];?></td>
							<td colspan="2"> <?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['enq_ref_two_address'];?></td>							
						</tr>
					</tbody>
				</table>
				<br/>
				<table style="width:100%;">
					...
					<tbody>
						<tr>
							<td style="height: 27px;">
								 <?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['relative_ref_name'];?>
							</td>
							<td style="height: 27px;">
								<?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['relative_ref_relation'];?>
							</td >
								<td  style="height: 27px;">
								 <?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['relative_ref_designation'];?> 
							</td>
							<td style="height: 27px;">
								 <?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['relative_ref_contact'];?>
							</td>
							<td style="height: 27px;">
								 <?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['relative_ref_email'];?>
							</td>
							<td style="height: 27px;">
								
								<?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['relative_ref_address'];?>
							</td>
						</tr>
						<tr>
						</tr>
						...
						if(!empty($applicaitonSfsStepThree))
						{
							...
							elseif($applicaitonSfsStepThree[0]['is_iccr_scholarship_avail_before'] == 2){
								echo 'No';
							}
						}
						?>
					...
					<tbody>
						<tr>
							<td style="height: 35px;">
								 <?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['iccr_scholar_year'];?>
							</td>
							<td style="height: 35px;">
						...
						?>	
								...
								<?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['iccr_scholar_institute'];?>
							</td>
							<td style="height: 35px;">
								
								 <?php
								  if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['iccr_scholar_duration_from']; 
								 echo '-';
								 if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['iccr_scholar_duration_to'];
								 ?>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td style="height: 35px;">
								...
								if(!empty($applicaitonSfsStepThree))
								{
									if($applicaitonSfsStepThree[0]['currently_non_nri'] == 1){
										echo 'Yes';
									}
									elseif($applicaitonSfsStepThree[0]['currently_non_nri'] == 2){
										echo 'No';
									}
								}						
								?>
									...
									?>
									 ...
									 <td>
										 <label for="comment">Postal Address</label>
											...
											<?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['currently_non_nri_address'];?>
						...
						<?php
										...
										<table style="width:100%;">
											<tbody>
												<tr>
													...
													<td><?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['is_international_lic_no'];?>					   </td>
													<td style="font-weight:bold;">Issuing Authority:</td>
													<td><?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['is_international_lic_auth'];?></td>
												</tr>
											</tbody>
										</table>	
										</td>
							...
							<tr>
								<td> <?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['any_other_info'];?></td>
							</tr>	
							<tr>
							...
							<tr><td  style="height: 25px;font-weight: bold; text-align: left;"> 
								<label for="comment" >Place: </label> <?php if(!empty($applicaitonSfsStepThree)) echo $applicaitonSfsStepThree[0]['place'];?>
						  ...
						  <a target="_blank" href="<?php echo site_url(); ?>assets/site/main/profile_sfs_signature/<?php echo $applicaitonSfsStepThree[0]['signature_doc']; ?>" target="_blank" title="Click to View Signature"><img  style="padding:2px;width:150px;height:75px;" src="<?php echo site_url(); ?><?php echo $user_data['dir'].'/'.$applicaitonSfsStepThree[0]['signature_doc']; ?>"/></a><br/>
	...
	if(count($applicaitonSfsDocuments) > 0)
	{
		foreach($applicaitonSfsDocuments as $docs)
		{
              	...
              	<div class="passport-sec col-xs-12 col-sm-12 col-md-12 pdleft pdright">
					<table class="table">
						...
						<tbody>
							...
							<?php
							if(count($applicaitonSfsStepOne) > 0 && $applicaitonSfsStepOne[0]['passport_no']!= "")
							{
							?>
							<tr>
								<td><?php echo $counter; $counter++;?></td>
							...
							?>
							<?php
						//	if(count($applicaitonSfsStepTwo) > 0 && $applicaitonSfsStepTwo[0]['school_leaving_country'] != "" && $applicaitonSfsStepTwo[0]['school_leaving_country'] > 0)
							...
							?>
							<?php
							//if(count($applicaitonSfsStepTwo) > 0 && $applicaitonSfsStepTwo[0]['ug_leaving_country'] != "" && $applicaitonSfsStepTwo[0]['ug_leaving_country'] > 0)
							...
							?>
							<?php
							//if(count($applicaitonSfsStepTwo) > 0 && $applicaitonSfsStepTwo[0]['pg_leaving_country'] != "" && $applicaitonSfsStepTwo[0]['pg_leaving_country'] > 0)
							...
							?>
							<?php
							//if(count($applicaitonSfsStepTwo) > 0 && $applicaitonSfsStepTwo[0]['mphil_leaving_country'] != "" && $applicaitonSfsStepTwo[0]['mphil_leaving_country'] > 0)
							...
							?>
							<?php
							//if(count($applicaitonSfsStepTwo) > 0 && $applicaitonSfsStepTwo[0]['phd_leaving_country'] != "" && $applicaitonSfsStepTwo[0]['phd_leaving_country'] > 0)
							...
							?>
							<?php							
							if(count($applicaitonSfsStepThree) > 0 && $applicaitonSfsStepThree[0]['currently_non_nri'] != "" && $applicaitonSfsStepThree[0]['currently_non_nri'] > 0 && $applicaitonSfsStepThree[0]['currently_non_nri'] == 1)
							{
							?>
							<tr>
								<td><?php echo $counter; $counter++;?></td>
							...
							?>		
							<?php							
							if(count($applicaitonSfsStepThree) > 0 && $applicaitonSfsStepThree[0]['is_international_lic'] != "" && $applicaitonSfsStepThree[0]['is_international_lic'] > 0 && $applicaitonSfsStepThree[0]['is_international_lic'] == 1)
							{
							?>
							<tr>
								<td><?php echo $counter; $counter++;?></td>
