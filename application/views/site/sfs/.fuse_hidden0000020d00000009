	...
	<div class="tab-content">
	  ...
	  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
              <div class="box-body">
						...
						<tr>
								...
								<td>
								  ...
								  if(array_key_exists($doctypes['id']['type'],$docsArray))
								  {
								  	$upload++;
								  ?>
								  <a href="#" data-toggle="modal" class="upload_link" data-target="#idProofSfsDiv">Re-Upload</a>
								  ...
								  {
								  ?>
								  <a href="#" data-toggle="modal" class="upload_link" data-target="#idProofSfsDiv">Upload</a>
								  <?php	
								  }
								  ?>	
							...
							<tr>
								...
								<?php
								  if(array_key_exists($doctypes['passport']['type'],$docsArray))
								  {
								  	$upload++;
								  ?>
								   <a href="#"  data-toggle="modal" class="upload_link" data-target="#passportSfsDiv">Re-Upload</a>
								  ...
								  {
								  ?>
								 <a href="#"  data-toggle="modal" class="upload_link" data-target="#passportDivSfs">Upload</a>
								  <?php	
								  }
								  ?>
							...
							<?php
								...
								{
									case "UG":									
							if(count($applicaitonSfsStepOne) > 0 && $applicaitonSfsStepTwo[0]['school_leaving_country'] != "" && $applicaitonSfsStepTwo[0]['school_leaving_country'] > 0)
							{								
							?>
							<tr>
								<td><?php echo $counter; $counter++;?></td>
								...
								<?php
								  if(array_key_exists($doctypes['school_leaving']['type'],$docsArray))
								  {
								  	$upload++;
								  ?>
								  <a href="#"  data-toggle="modal" class="upload_link" data-target="#schoolLivingDivSfs">Re-Upload</a>
								  ...
								  {
								  ?>
								 <a href="#"  data-toggle="modal" class="upload_link" data-target="#schoolLivingDivSfs">Upload</a>
								  <?php	
								  }
								  ?>
							...
							<?php	
								...
								<?php
								  if(array_key_exists($doctypes['ug']['type'],$docsArray))
								  {
								  	$upload++;
								  ?>
								  <a href="#"  data-toggle="modal" class="upload_link" data-target="#underGraduateDivSfs">Re-Upload</a>
								  ...
								  {
								  ?>
								 <a href="#"  data-toggle="modal" class="upload_link" data-target="#underGraduateDivSfs">Upload</a>
								  <?php	
								  }
								  ?>
							...
							<tr>
								...
								<?php
								  if(array_key_exists($doctypes['pg']['type'],$docsArray))
								  {
								  	$upload++;
								  ?>
								  <a href="#"  data-toggle="modal" class="upload_link" data-target="#postGraduateDivSfs">Re-Upload</a>
								  ...
								  {
								  ?>
								 <a href="#"  data-toggle="modal" class="upload_link" data-target="#postGraduateDivSfs">Upload</a>
								  <?php	
								  }
								  ?>
							...
							<tr>
								...
								<?php
								  if(array_key_exists($doctypes['phd']['type'],$docsArray))
								  {
								  	$upload++;
								  ?>
								  <a href="#"  data-toggle="modal" class="upload_link" data-target="#phdDivSfs">Re-Upload</a>
								  ...
								  {
								  ?>
								 <a href="#"  data-toggle="modal" class="upload_link" data-target="#phdDivSFS">Upload</a>
								  <?php	
								  }
								  ?>
							...
							<tr>
								...
								<?php
								  if(array_key_exists($doctypes['physical']['type'],$docsArray))
								  {
								  	$upload++;
								  ?>
								   <a href="#"  data-toggle="modal" class="upload_link" data-target="#physicalFitnessDivSfs">Re-Upload</a>
								  ...
								  {
								  ?>
								 <a href="#"  data-toggle="modal" class="upload_link" data-target="#physicalFitnessDivSfs">Upload</a>
								  <?php	
								  }
								  ?>
							...
							<!----<td><?php echo '9';?></td>--->
								...
								<?php
								  if(array_key_exists($doctypes['tl']['type'],$docsArray))
								  {
								  	//$upload++;
								  ?>
								   <a href="#"  data-toggle="modal" class="upload_link" data-target="#translationDivSfs">Re-Upload</a>
								  ...
								  {
								  ?>
								 <a href="#"  data-toggle="modal" class="upload_link" data-target="#translationDivSfs">Upload</a>
								  <?php	
								  }
								  ?>
								...
								<?php
								  if(array_key_exists($doctypes['otherDoc']['type'],$docsArray))
								  {
								  	//$upload++;
								  ?>
								   <a href="#"  data-toggle="modal" class="upload_link" data-target="#otherDocDivSfs">Re-Upload</a>
								  ...
								  {
								  ?>
								 <a href="#"  data-toggle="modal" class="upload_link" data-target="#otherDocDivSfs">Upload</a>
								  <?php	
								  }
								  ?>
                ...
                if($upload == ($counter-1))
                {
                	//print_r($applicaitonSfsStepOne);
                	if($applicaitonSfsStepOne[0]['status']=="Pending")
					{
						?>
							<input type="submit" class="form-control btn btn-info" value="Re-Submit"/>
						<?php	
					}
					else
					{
						?>
							<input type="submit" class="form-control btn btn-info" value="Final Submit" "/>
						<?php	
					}
				}
				else
				{
					...
					{						
						?>
						<a class="btn btn-info disabled">Re-Submit</a>						
						<?php
					}
					else
					{
						?>
						<a class="btn btn-info disabled">Final Submit</a>						
						<?php
					}
				}
                ?>                
...
<div id="schoolLivingDiv" class="modal fade" role="dialog">
  ...
  <div id="schoolLivingDivSfs" class="modal fade" role="dialog">
  	<div id="schoolLivingSfs" class="modal-dialog popup dropzone">
  			<div class="dz-message" data-dz-message><span>Click/Drop PDF file Here</span></div>
  		</div>
  </div>
  <div id="underGraduateDivSfs" class="modal fade" role="dialog">
  	<div id="underGraduateSfs" class="modal-dialog popup dropzone">
  			<div class="dz-message" data-dz-message><span>Click/Drop Image/PDF file Here</span></div>
  		</div>
  </div>
  <div id="postGraduateDivSfs" class="modal fade" role="dialog">
  	<div id="postGraduateSfs" class="modal-dialog popup dropzone">
  			<div class="dz-message" data-dz-message><span>Click/Drop Image/PDF file Here</span></div>
  		</div>
  </div>
  ...
  <div id="phdDiv" class="modal fade" role="dialog">
    ...
    <div id="phdDivSfs" class="modal fade" role="dialog">
  	<div id="phdSfs" class="modal-dialog popup dropzone">
  			<div class="dz-message" data-dz-message><span>Click/Drop Image/PDF file Here</span></div>
  		</div>
  </div>
  ...
  <div id="idProofSfsDiv" class="modal fade" role="dialog">
  	<div id="idProofSfs" class="modal-dialog popup dropzone">
  			<div class="dz-message" data-dz-message><span>Click/Drop Image/PDF file Here</span></div>
  		</div>
  </div>
  ...
  <div id="physicalFitnessDivSfs" class="modal fade" role="dialog">
  	<div id="physicalFitnessSfs" class="modal-dialog popup dropzone">
  			<div class="dz-message" data-dz-message><span>Click/Drop Image/PDF file Here</span></div>
  		</div>
  </div>
  ...
  <div id="passportDivSfs" class="modal fade" role="dialog">
  	<div id="passportSfs" class="modal-dialog popup dropzone">
  		<div class="dz-message" data-dz-message><span>Click/Drop Image/PDF file Here</span></div>
  	</div>
  </div>
  ...
  <div id="translationDivSfs" class="modal fade" role="dialog">
  	<div id="translationUploadSfs" class="modal-dialog popup dropzone">
  		<div class="dz-message" data-dz-message><span>Click/Drop Image/PDF file Here</span></div>
  	</div>
  </div>
    <div id="phdResearchDivSfs" class="modal fade" role="dialog">
   ...
   <div id="otherDocDiv" class="modal fade" role="dialog">
     ...
     <div id="otherDocDivSfs" class="modal fade" role="dialog">
  	<div id="otherDocSfs" class="modal-dialog popup dropzone">
  			<div class="dz-message" data-dz-message><span>Click/Drop Image/PDF file Hereother</span></div>
  		</div>
  </div>
	<script>
	  
 function notificationw(){

	alert('ok');
	
	BootstrapDialog.show({type: BootstrapDialog.TYPE_WARNING ,title: "Warning" ,message: "Are you sure you want to Confirm!!" ,buttons: [{label: 'Ok',action: function(dialogItself)
	{
	...
	{label: 'Cancel',action: function(dialogItself) {dialogItself.close();}}]}); 
		...
		function notificationretret(){
	bootbox.prompt({
    title: "Are you applying for PHD!",
...
function notificationgfhfgh(){
bootbox.confirm({
    title: "Waring Message?",
    message: "<p>(A.)Incomplete/Wrong information by the applicant shall be liable for rejection of the Application.</br></br>(B.)Photo background to be white and selfie photographs will not be considered.</br></br>(C.)Any other checklist for mission can be incorporated here before the applicans are forwarded to ROs.</p>",
    buttons: {
 ...
 function notification(){
	...
	BootstrapDialog.show({type: BootstrapDialog.TYPE_WARNING ,title: "Warning" ,message: "<p>(A.)Incomplete/Wrong information by the applicant shall be liable for rejection of the Application.</br></br>(B.)Photo background to be white and selfie photographs will not be considered.</br></br>(C.)Any other checklist for mission can be incorporated here before the applications are forwarded to ROs.</p>" ,buttons: [{label: 'Ok',action: function(dialogItself)
	{
