...
<section class="meacontent">	
	<div class="col-xs-10 form_head">		
		...
		<h3 class="text-center caps">Indian Council For Cultural Relations(Alumni Details)</h3>
              ...
              <div class="box-body">
              	<div class="col-xs-3 prfl pull-right" >
              		<?php 
						...
						?>
						<img style="width:151px;height:171px;align:center;" id="profil_image_div" src="<?php echo site_url();?>assets/site/main/alumni_pic/<?php echo $userImage; ?>"/>
						<?php		
						}
              		?>
              	</div>
						  ...
						  ?>
							...
							<tr>
								...
								<table id="tblpassport" class="table" style="width: 100%;">
									...
									<tbody>
										<tr>
											<td>Date of Issue : - <?php if(!empty($alunamiapplication)) echo $alunamiapplication[0]['passport_issue_date'].'-'.$alunamiapplication[0]['passport_issue_month'].'-'.$alunamiapplication[0]['passport_issue_year']; ?></td>
											<td>Date of Expiry : - <?php if(!empty($alunamiapplication)) echo $alunamiapplication[0]['passport_expiry_date'].'-'.$alunamiapplication[0]['passport_expiry_month'].'-'.$alunamiapplication[0]['passport_expiry_year']; ?></td>
											<td>Place of Issue : - <?php if(!empty($alunamiapplication)) echo $alunamiapplication[0]['passport_issue_place'];?></td>
										</tr>
									</tbody>
								</table>
							...
							<tr>
								...
								<table id="tblpassport" class="table" style="width: 100%;">
									<thead>
										<th style="width:150px; ">a) Date of Arrival</th>
										<th style="width:150px; ">b) Date of Departure</th>
									
									</thead>
									<tbody>
										<tr>
										
											<td>Date of Arrival : - <?php if(!empty($alunamiapplication)) echo $alunamiapplication[0]['date_of_arrival'];?></td>
											<td>Date of Departure : - <?php if(!empty($alunamiapplication)) echo $alunamiapplication[0]['date_of_departure'];?></td>
										</tr>
									</tbody>
								</table>
