...
<section class="meacontent">	
	<div class="col-xs-10 form_head">		
		...
		<h3 class="text-center caps">Add Bank Details for Further Communication</h3>	
	    	  ...
	    	  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">		
	    	  	<input type="hidden" name="appid" id="appid" value="<?php echo $this->uri->segment(3); ?>">			
	    	  		<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">Bank Name</label>
					    <div class="col-sm-4">				      	
					     	 <input type="text" class="form-control" placeholder="Bank Name" id="bankname" name="bankname" required="true">
					    </div>	
					</div>
					<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">Account Number</label>
					    <div class="col-sm-4">				      	
					     	 <input type="text" class="form-control" placeholder="Account Number" id="accno" name="accno"  required="true">
					    </div>	
					</div>
					<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">Bank Document</label>
					    <div class="col-sm-4">				      	
