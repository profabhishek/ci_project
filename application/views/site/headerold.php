		...
		<div class="collapse navbar-collapse" id="defaultNavbar2" style="padding-left:0;">
			...
			//	$segment = $this->uri->segment(3);
				...
				<ul class="dropdown-menu registrationul">
					<!---<li><a href="<?php echo base_url();?>home/register" style="background: #F6751D;box-shadow: 4px 1px 16px #fff inset;font-weight: 500;" onclick ="reg()">Applicant Registration</a></li>-->
