...
<section class="meacontent">	
	...
	<div class="tab-content">
	  ...
	  <form id="form-two-application" action="<?php echo site_url();?>applicant?appno=<?php echo html_escape($_GET['appno']); ?>" method="post" enctype="multipart/form-data">   
	  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
              <div class="box-body">
              	<div class="passport-sec col-xs-12 col-sm-12 col-md-12 pdleft pdright">
					<table class="table">
						...
						<tr>
							...
							<!----<td><?php echo '9';?></td>--->
								<td><?php echo $counter; $counter++;;?></td>
								<td><?php echo $doctypes['tl']['title'];?><span class="text-red">*</span> &nbsp;<b>(Compulsory)</b></td>
								<td>
								<?php
                ...
                ?>                
                  ...
                  <div class="name-sec col-xs-4 col-sm-2 col-md-4 pull-right">
				  <a href="<?php echo site_url();?>applicant/applicant_other_info?appno=<?php echo html_escape($_GET['appno']); ?>" class="form-control sbmt"><< Previous</a>
				  </div>     

					<div class="name-sec col-xs-4 col-sm-2 col-md-4 pull-right">
				  <a href="<?php echo site_url();?>applicant/applicant_document_info_view?appno=<?php echo html_escape($_GET['appno']); ?>" class="form-control sbmt">Preview</a>
				  </div>
              	</div>
              </div>
              <!-- /.box-body -->
