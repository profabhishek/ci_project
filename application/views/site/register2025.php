      ...
      <form id="identicalForm" action="<?php echo site_url(); ?>user/register" onsubmit="return validate_registration();" enctype="multipart/form-data" method="post" data-fv-framework="bootstrap" data-fv-icon-valid="glyphicon glyphicon-ok" data-fv-icon-invalid="glyphicon glyphicon-remove" data-fv-icon-validating="glyphicon glyphicon-refresh">
        <div class="box-body">
          ...
          <div class="name-sec col-xs-12 col-sm-3 col-md-3">
            ...
            <div class="form-group">
              <input class="form-control capitalLetter" id="mother_mname" pattern="^[a-zA-Z ]+$" title="Provide your mother’s middle name (if any). Leave blank if not applicable." name="mother_mname" placeholder="Enter Middle Name" maxlength="15">
            </div>
          </div>
          <div class="name-sec col-xs-12 col-sm-3 col-md-3">
          ...
          <div class="name-sec col-xs-12 col-sm-3 col-md-3">
            ...
            <div class="form-group">
              ...
              <select class="form-control select2" title="Select your gender (Male/Female) as per your official records." name="gender" id="gender" style="width: 100%;" required="true">
                <option value="">Select</option>
          ...
          <div class="name-sec col-xs-12 col-sm-2 col-md-3">
            <label for="exampleInputEmail1">Email addres <span class="text-red">*</span></label>
            <div class="form-group">
          ...
          <div class="name-sec col-xs-12 col-sm-3 col-md-3">
            <label for="comment">Local ID<span class="text-red">*</span></label>
            <div class="form-group">
          ...
          <script>
            document.getElementById('dob').addEventListener('change', function () {
                ...
                // Set hidden fields (existing logic)
...
Note: Please note that no Local Ids to be mentioned in this column." id="passport_no" name="passport_no" placeholder="Enter Passport" maxlength="10" required="true">
          ...
          <div class="name-sec col-xs-12 col-sm-2 col-md-3">
            ...
            <div class="form-group">
              <input type="file" title="Upload password" class="form-control" id="passport" name="passport" required="true">
            </div>
          </div>
