...
<div class="col-xs-10 form_head">
    ...
    <h3 class="text-center caps">Student Registration(2023-2024) for ICCR Scholarship Programme</h3>
        ...
        <div class="box-body">
            ...
            <div class="form-group">
              ...
              <select class="form-control select2" name="apply_course_type" id="apply_course_type" style="width: 100%;" required="true">
               ...
               <!-- <option value="1">UG</option>
                ...
                <!-- <option value="3">M.Phil(Under all Scholarship Schemes for ICCR)</option>
                <option value="5">Dance (with Guru's)</option>
                <option value="6">Music (with Guru's)</option>
                <option value="10">Ayush Course (UG/PG/PhD in Ayuerveda,Yoga,Unani,Siddha and Homoeopathy)</option>-->
              </select>
            </div>
          </div>
          <div class="name-sec col-xs-12 col-sm-3 col-md-3">
            ...
            <div class="form-group">
              ...
              <select class="form-control select2" name="country" id="country" style="width: 100%;" required="true">
                <option value="">Select</option>
                <?php
                $countries = $this->common_model->getCountriesByIdNotInCurrentforKazakhstan();
          ...
          <div class="name-sec col-xs-12 col-sm-3 col-md-3">
            ...
            <div class="form-group">
              ...
              <input class="form-control capitalLetter" id="student_fname" pattern="^[a-zA-Z ]+$" title="A-Z" name="student_fname" placeholder="Enter Name" required="true">
            </div>
          </div>
          <div class="name-sec col-xs-12 col-sm-3 col-md-3">
            ...
            <div class="form-group">
              ...
              <input class="form-control capitalLetter" id="student_mname" pattern="^[a-zA-Z ]+$" title="A-Z" name="student_mname" placeholder="Enter Middle Name">
            </div>
          </div>
          <div class="name-sec col-xs-12 col-sm-3 col-md-3">
            ...
            <div class="form-group">
              ...
              <input class="form-control capitalLetter" id="student_lname" pattern="^[a-zA-Z ]+$" title="A-Z" name="student_lname" placeholder="Enter Last Name" required="true">
            </div>
          </div>
          ...
          <div class="name-sec col-xs-12 col-sm-3 col-md-3">
            ...
            <div class="form-group">
              ...
              <input class="form-control capitalLetter" id="father_fname" pattern="^[a-zA-Z ]+$" title="A-Z" name="father_fname" placeholder="Enter First Name" required="true">
            </div>
          </div>
          <div class="name-sec col-xs-12 col-sm-3 col-md-3">
            ...
            <div class="form-group">
              ...
              <input class="form-control capitalLetter" id="father_mname" pattern="^[a-zA-Z ]+$" title="A-Z" name="father_mname" placeholder="Enter Middle Name">
            </div>
          </div>
          <div class="name-sec col-xs-12 col-sm-3 col-md-3">
            ...
            <div class="form-group">
              ...
              <input class="form-control capitalLetter" id="father_lname" pattern="^[a-zA-Z ]+$" title="A-Z" name="father_lname" placeholder="Enter Last Name" required="true">
            </div>
          </div>
          <div class="name-sec col-xs-12 col-sm-3 col-md-3">
            ...
            <div class="form-group">
              ...
              <input class="form-control capitalLetter" id="mother_fname" pattern="^[a-zA-Z ]+$" title="A-Z" name="mother_fname" placeholder="Enter First Name" required="true">
            </div>
          </div>
          <div class="name-sec col-xs-12 col-sm-3 col-md-3">
            ...
            <div class="form-group">
              ...
              <input class="form-control capitalLetter" id="mother_mname" pattern="^[a-zA-Z ]+$" title="A-Z" name="mother_mname" placeholder="Enter Middle Name">
            </div>
          </div>
          <div class="name-sec col-xs-12 col-sm-3 col-md-3">
            ...
            <div class="form-group">
              ...
              <input class="form-control capitalLetter" id="mother_lname" pattern="^[a-zA-Z ]+$" title="A-Z" name="mother_lname" placeholder="Enter Last Name" required="true">
            </div>
          </div>
          ...
          <div class="name-sec col-xs-12 col-sm-3 col-md-4 pdleft1">
          ...
          <div class="name-sec col-xs-12 col-sm-2 col-md-5">
          ...
          <div class="col-xs-12 col-sm-3 col-md-3">
            <label for="comment">Unique Identification No<span class="text-red">*</span></label>
            <input type="text" class="form-control capitalLetter" id="unique_id" name="unique_id" placeholder="Unique ID" required="true" />
          </div>


          <div class="name-sec col-xs-12 col-sm-2 col-md-4">
          ...
          <div class="name-sec col-xs-12 col-sm-2 col-md-12">
            <br>
          </div>
          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="col-lg-10">
                ...
                <input type="number" class="form-control" name="otp" id="inputOtp">
              </div>
              <div class="col-lg-2">
