...
<section class="meacontent">	
	<div class="col-xs-10 form_head">		
		...
		<h3 class="text-center caps">Add FRRO Details of Applicant</h3>	
	...
	<div class="tab-content footr">		
	  <div id="home" class="tab-pane fade in active">	   
	    <form action="<?php echo site_url();?>applicant/submitbankDetails/<?php echo $this->uri->segment(3); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
	    <div class="box-body">
	    	  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">		
	    	  	<input type="hidden" name="appid" id="appid" value="<?php echo $this->uri->segment(3); ?>">			
	    	  		<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">Residential Permit Number</label>
					    <div class="col-sm-4">				      	
					     	 <input type="text" class="form-control" placeholder="Residential Permit Number" id="fronumber" name="fronumber" required="true">
					    </div>	
					</div>
					<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">Details of Issuing Authority</label>
					    <div class="col-sm-4">				      	
					     	 <input type="text" class="form-control" placeholder="Details of Issuing Authority" id="accno" name="accno"  required="true">
					    </div>	
					</div>
					<div class="form-group col-xs-9">
					...
					<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">Upload Copy of Residential Permit</label>
					    <div class="col-sm-4">				      	
					     	  <input  id="bank_doc" name="bank_doc" type="file"  required="true">
					    </div>	
					</div>
					<div class="form-group col-xs-9">
					    <label for="inputEmail3" class="col-sm-2">Validity of Residential Permit</label>
					    <div class="col-sm-2">				      	
					     	  <input type="text" class="form-control datepicker_visa_issuedate" id="fromdate" name="fromdate" placeholder="From">
					    </div>
					    <div class="col-sm-2">				      	
					     	  <input type="text" class="form-control datepicker_visa_issuedate" id="todate" name="todate" placeholder="To">
					    </div>	
					</div>						
				...
				<br/><br/><br/><br/>
					...
					<div class="form-group col-xs-5 pull-right" style="width: 416px;">
					    <label for="" class="col-sm-3">Applicant Signature</label>
					    <div class="col-sm-8">
					      <img style="border:1px solid #cecece;padding:2px;width:104px;max-height:40px;" src="<?php echo site_url();?>assets/site/main/profile_signature/<?php echo $applicaitonStatus[0]['signature_doc'];?>"/>
					    </div>					    
					</div>
