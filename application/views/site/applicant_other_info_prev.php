	...
	<div class="tab-content detailpagepdf">		
	 ...
	 <?php
						...
						?>
							...
							<tr>
								<td style="height:35px;max-width:120px;font-weight: bold;" colspan="2"><label>12. Essey:</label></td>
							</tr>
							<tr>
...
<div class="box-body">  
				...
				<table style="width:100%;">
					...
					<tbody>
						...
						<tr>
							<td style="height: 35px;">
								<label>21. Do you have an International driving licence?</label>&nbsp;&nbsp;
								<?php
									if(!empty($applicaitonStepThree))
									{
						...
						<?php
							...
							<tr>
							<td style="height: 35px;">
								<label>22. Are you married to an indian national ?</label>&nbsp;&nbsp;
								<?php
								if(!empty($applicaitonStepThree))
								{
							...
							<tr>
								<td style="height: 35px;font-weight: bold;"><label>23. Any Other Information.</label></td>
							</tr>	
							<tr>
							...
							<tr>
								<td  style="height: 25px;font-weight: bold;"><label>Date: <?php
									if(!empty($applicaitonStepThree)){
								$date2 = $applicaitonStepThree[0]['created'];	
						  ...
						  <a target="_blank"><img  style="padding:2px;width:150px;height:75px;" src="data:<?php echo $mime_type;?>;base64,<?php echo $data;?>"/><br/>
