...
<section class="meacontent">	
	<div class="col-xs-10 form_head">		
		...
		<h4 class="text-center caps">Complaints</h4>
	</div>
	
	<div  class="container" style="min-height:150px;padding:0px;">	
	<div class="blue-heading col-md-12 ">
			 <h3>Complaints</h3>		
		 <a class="form-control lnk"  href="<?php echo site_url();?>applicant/createcomplaint/<?php echo $this->uri->segment(3);?>">New Complaint</a>
		</div>	
