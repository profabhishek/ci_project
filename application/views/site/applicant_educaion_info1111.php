                ...
                <form id="form-process-education-info" enctype="multipart/form-data" method="post">
                    ...
                    <div class="box-body">
                        ...
                        <div class="passport-sec col-xs-12 col-sm-12 col-md-12 pdleft pdright">
                            <table class="table">
								...
								switch($program)
								{
                                    ...
                                    <tr>
                                        <td>Secondary / High School<br />(equivalent to Grade X in India) <span
                                    ...
                                    <tr>
                                        <td>High School/College<br />(equivalent to Grade XII in India) <span
                                                class="text-red">*</span></td>
                                        <td>
                            ...
                            <table class="table">
								...
								?>
                                <tr>
                                    <td>Secondary High School<br />(equivalent to Grade X in India) <span class="text-red">*</span>
                                    </td>
                                    <td>
                                        <select id="school_leaving_country_x"
                                            name="school_leaving_country_x"
                                ...
                                <tr>
                                    <td>High School/College<br />(equivalent to Grade XII in India)<span class="text-red">*</span>
                                    </td>
                                    <td>
                                        <select id="school_leaving_country"
                                            name="school_leaving_country"
                        ...
                        <!--<div class="passport-sec col-xs-12 col-sm-12 col-md-12 pdleft pdright">
                          ...
                          $ug_required  = '';
                          $pg_required  = '';
                          $phd_required = ''; // always optional now

                          if ($apply_course_type == 2) {
                              $ug_required = 'required';
                          }
                          elseif ($apply_course_type == 4) {
                              $ug_required = 'required';
                        ...
                        <div class="passport-sec col-xs-12 col-sm-12 col-md-12 pdleft pdright">
                            <table class="table">
                                <thead>
                                  <tr><td colspan="5"><h4>Undergraduate Course Details</h4></td></tr>
                                  <tr>
                                    <th>Country</th>
                                    <th>Name of University</th>
                                    <th>Course</th>
                                ...
                                <tbody id="TextBoxContainer">
                                    ...
                                    ?>
                                        <tr>
                                            <td>
                                                <select id="other_course_country" name="other_course_country[]" class="selectpicker form-control" <?= $ug_required ?>>
                                                    <option value="">Country</option>
                                                    <?php
                                                        $countries = $this->common_model->getCountries();
                                                        foreach($countries as $country)
                                            ...
                                            <td>
                                                <input class="form-control capitalLetter" id="other_course_university" name="other_course_university[]" maxlength="150" placeholder="University/Institute" type="text" value="<?php echo $value['other_course_university'];?>" <?= $ug_required ?> />
                                            </td>

                                            <td>
                                                <input class="form-control capitalLetter" id="other_course" name="other_course[]" maxlength="150" placeholder="Course" type="text" value="<?php echo $value['other_course'];?>" <?= $ug_required ?> />
                                            </td>

                                            <td>
                                                <input class="form-control capitalLetter" id="other_course_year" name="other_course_year[]" maxlength="4" placeholder="Year" type="number" value="<?php echo $value['other_course_year'];?>" <?= $ug_required ?> />
                                            </td>

                                            <td>
                                                <input class="form-control capitalLetter" id="other_course_percentage" name="other_course_percentage[]" placeholder="Percentage(%)" type="number" step="0.01" value="<?php echo $value['other_course_percentage'];?>" <?= $ug_required ?> />
                                            </td>
                                            <td>
                                    ...
                                    <tr class="attr">
                                        ...
                                        <td>
                                            <input class="form-control capitalLetter" id="other_course_university" name="other_course_university[]" maxlength="150" placeholder="University/Institute" type="text" value="<?php if(!empty($applicaitonStepTwo)) echo $applicaitonStepTwo[0]['other_course_university'];?>" <?= $ug_required ?> />
                                        </td>

                                        <td>
                                            <input class="form-control capitalLetter" id="other_course" name="other_course[]" maxlength="150" placeholder="Course" type="text" value="<?php if(!empty($applicaitonStepTwo)) echo $applicaitonStepTwo[0]['other_course'];?>" <?= $ug_required ?> />
                                        </td>

                                        <td>
                                            <input class="form-control capitalLetter" id="other_course_year" name="other_course_year[]" placeholder="Year" type="number" value="<?php if(!empty($applicaitonStepTwo)) echo $applicaitonStepTwo[0]['other_course_year'];?>" <?= $ug_required ?> />
                                        </td>

                                        <td>
                                            <input class="form-control capitalLetter" id="other_course_percentage" name="other_course_percentage[]" placeholder="Percentage(%)" type="number" step="0.01" value="<?php if(!empty($applicaitonStepTwo)) echo $applicaitonStepTwo[0]['other_course_percentage'];?>" <?= $ug_required ?> />
                                        </td>
                                        <td>
                                            <a href="javascript:;" class="btn btn-danger remove"><i class="fa fa-trash"></i></a>
                                        </td>
      					...
      					<div class="passport-sec col-xs-12 col-sm-12 col-md-12 pdleft pdright">
                            <div class="name-sec col-xs-12 col-sm-6 col-md-12">
                                <div class="form-group">
                                    <span class="note1"><strong>Note : </strong>(For admission in any Bachelor’s level course minimum 12 years of education school/college is required.)</b></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="passport-sec col-xs-12 col-sm-12 col-md-12 pdleft pdright">
                            <table class="table">
                                <thead>
                                  <tr><td colspan="5"><h4>Postgraduate Course Details</h4></td></tr>
                                  <tr>
                                    <th>Country</th>
                                    <th>Name of University</th>
                                    <th>Course</th>
                                ...
                                <tbody id="TextBoxContainer">
                                    ...
                                    ?>
                                        <tr>
                                            <td>
                                                <select id="other_course_country" name="other_course_country[]" class="selectpicker form-control" <?= $pg_required ?>>
                                                    <option value="">Country</option>
                                                    <?php
                                                        $countries = $this->common_model->getCountries();
                                                        foreach($countries as $country)
                                            ...
                                            <td>
                                                <input class="form-control capitalLetter" id="other_course_university" name="other_course_university[]" maxlength="150" placeholder="University/Institute" type="text" value="<?php echo $value['other_course_university'];?>" <?= $pg_required ?> />
                                            </td>

                                            <td>
                                                <input class="form-control capitalLetter" id="other_course" name="other_course[]" maxlength="150" placeholder="Course" type="text" value="<?php echo $value['other_course'];?>" <?= $pg_required ?> />
                                            </td>

                                            <td>
                                                <input class="form-control capitalLetter" id="other_course_year" name="other_course_year[]" maxlength="4" placeholder="Year" type="number" value="<?php echo $value['other_course_year'];?>" <?= $pg_required ?> />
                                            </td>

                                            <td>
                                                <input class="form-control capitalLetter" id="other_course_percentage" name="other_course_percentage[]" placeholder="Percentage(%)" type="number" step="0.01" value="<?php echo $value['other_course_percentage'];?>" <?= $pg_required ?> />
                                            </td>
                                            <td>
                                                <!-- <a href="javascript:;" class="btn btn-danger remove"><i class="fa fa-trash"></i></a> -->
                                            </td>
                                    ...
                                    <tr class="attr">
                                        ...
                                        <td>
                                            <input class="form-control capitalLetter" id="other_course_university" name="other_course_university[]" maxlength="150" placeholder="University/Institute" type="text" value="<?php if(!empty($applicaitonStepTwo)) echo $applicaitonStepTwo[0]['other_course_university'];?>" <?= $pg_required ?> />
                                        </td>

                                        <td>
                                            <input class="form-control capitalLetter" id="other_course" name="other_course[]" maxlength="150" placeholder="Course" type="text" value="<?php if(!empty($applicaitonStepTwo)) echo $applicaitonStepTwo[0]['other_course'];?>" <?= $pg_required ?> />
                                        </td>

                                        <td>
                                            <input class="form-control capitalLetter" id="other_course_year" name="other_course_year[]" placeholder="Year" type="number" value="<?php if(!empty($applicaitonStepTwo)) echo $applicaitonStepTwo[0]['other_course_year'];?>" <?= $pg_required ?> />
                                        </td>

                                        <td>
                                            <input class="form-control capitalLetter" id="other_course_percentage" name="other_course_percentage[]" placeholder="Percentage(%)" type="number" step="0.01" value="<?php if(!empty($applicaitonStepTwo)) echo $applicaitonStepTwo[0]['other_course_percentage'];?>" <?= $pg_required ?> />
                                        </td>
                                        <td>
                                            <a href="javascript:;" class="btn btn-danger remove"><i class="fa fa-trash"></i></a>
                                        </td>
      					...
      					<div class="passport-sec col-xs-12 col-sm-12 col-md-12 pdleft pdright">
                            <div class="name-sec col-xs-12 col-sm-6 col-md-12">
                                <div class="form-group">
                                    <span class="note1"><strong>Note : </strong>(For admission in any Master’s level course minimum 15 years of 
                                      education school/college is required..<b>(Optional)</b></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="passport-sec col-xs-12 col-sm-12 col-md-12 pdleft pdright">
                            <table class="table">
                                <thead>
                                  <tr><td colspan="5"><h4>Research/PhD Course Details</h4></td></tr>
                                  <tr>
                                    <th>Country</th>
                                    <th>Name of University</th>
                                    <th>Course</th>
                                ...
                                <tbody id="TextBoxContainer">
                                    ...
                                    ?>
                                        <tr>
                                            <td>
                                                <select id="other_course_country" name="other_course_country[]" class="selectpicker form-control">
                                                    <option value="">Country</option>
                                                    <?php
                                                        $countries = $this->common_model->getCountries();
                                                        foreach($countries as $country)
                                            ...
                                            <td>
                                                <input class="form-control capitalLetter" id="other_course_university" name="other_course_university[]" maxlength="150" placeholder="University/Institute" type="text" value="<?php echo $value['other_course_university'];?>" />
                                            </td>

                                            <td>
                                                <input class="form-control capitalLetter" id="other_course" name="other_course[]" maxlength="150" placeholder="Course" type="text" value="<?php echo $value['other_course'];?>" />
                                            </td>

                                            <td>
                                                <input class="form-control capitalLetter" id="other_course_year" name="other_course_year[]" maxlength="4" placeholder="Year" type="number" value="<?php echo $value['other_course_year'];?>" />
                                            </td>
                                    ...
                                    <tr class="attr">
                                        ...
                                        <td>
                                            <input class="form-control capitalLetter" id="other_course_university" name="other_course_university[]" maxlength="150" placeholder="University/Institute" type="text" value="<?php if(!empty($applicaitonStepTwo)) echo $applicaitonStepTwo[0]['other_course_university'];?>" />
                                        </td>

                                        <td>
                                            <input class="form-control capitalLetter" id="other_course" name="other_course[]" maxlength="150" placeholder="Course" type="text" value="<?php if(!empty($applicaitonStepTwo)) echo $applicaitonStepTwo[0]['other_course'];?>" />
                                        </td>
