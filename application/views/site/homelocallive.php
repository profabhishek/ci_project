...
<section class="bannerarea" style="margin:0px auto;max-height: 440px;background: #9ac132;">
<div class="row">
<div class="col-12 col-sm-12 col-md-2 col-lg-2">
<div id="sidebar_container">
   
	<div class="sidebar-whats">
		<h3 style ="text-align:center; border:1px; color:white;font-weight: bold;">What's New</h3>
		<div style="overflow: hidden; position: relative; height: 320px;" class="news-container1">
			<ul>
					<?php $todate = date('Y-m-d');
					 $testimonials = $this->common_model->getActiveNotification($todate);
				...
				?>
				 <li><p>
				<img src="<?php echo base_url();?>assets/site/main/images/newnotification.gif.png" alt="new gif Image" ><a href="<?php echo site_url('home/notificationList/'.$testmonl['id']);?>"><?php echo $testmonl['title']?></a>
				</li>
				<?php  
				}
				?>
	...
	<div class="col-12 col-sm-12 col-md-8 col-lg-8">
		...
		<div class="sidebar-testimonials">
			<h3 style ="text-align:center;border:1px; color:white;font-weight: bold;">Testimonials</h3>
			<div style="overflow: hidden; position: relative; height: 320px;" class="news-container1">
				...
				<ul>
					...
					?>
					 <li><p>
					<img src="<?php echo base_url();?>assets/site/main/images/newnotification.gif.png" alt="new gif Image" ><a href="<?php echo $testmonl['url'];?>" target = "__blank"><?php echo $testmonl['title']?></a>
					</li>
					<?php  
					}
					?>
