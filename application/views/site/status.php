					...
					<table class="table">
						...
						<tbody>	
							...
							<tr>
								...
								elseif($applicaitonStatus[0]['universities_status'] = 22)
								{
									echo 'Confirmed';
								}
								...
								<td>
								<?php 
									if($applicaitonStatus[0]['universities_status'] = 22 && $applicaitonStatus[0]['status'] == 10)
								{
									?>
									<a style="float:left;width:104px;" href="<?php echo site_url();?>applicant/processConfirmedappfromhqrs/<?php echo $this->uri->segment(3);?>"  class="form-control sbmt1">Undertaking</a>
								...
								{
									?>
									<!---<a style="float:left;width:104px;" href="<?php echo site_url();?>applicant/processConfirmedappfromhqrs/<?php echo $this->uri->segment(3);?>"  class="form-control sbmt1">View</a>--->
									<a download href="<?php echo site_url();?>assets/site/main/undertakings/<?php echo $applicaitonStatus['undertaking_doc'];?>">Download</a>
									<?php
								}
								?>
								</td>
