...
<hr>
	...
	<div class="cnfrmeddd">
		<form action="<?php echo site_url();?>headquarter/saveconfirmedcourse/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>">
		<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">	
		<div class="form-group col-md-6" style="margin-left:25%;">
			<label>Enter University Confirmed Couse</label><br/><br/>
