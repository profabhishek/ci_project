              		...
              		<div class="form-group col-xs-9">
					    ...
					    <div class="col-sm-8">
						 ...
						 <option value="">Select</option>							 
						 	...
						 	{
						 		echo '<optgroup label="Indian Council of Agricultural Research Universities">';	
					...
					<div class="form-group col-xs-9">
					    ...
					    <div class="col-sm-8">
					      <select id="course" name="course" class="form-control" required="true">
						   ...
						   $programme = $courses['programme_id'];
					      	if(count($coursee)>0)
					      	{
								if($coursee[0] == '' || $coursee[1] == '' || $coursee[2] == ''){
									echo '<option value="'.$courses['programme_id'].'">'.$courses['programme'].'</option>';
								}
								if(is_array($coursee)){
