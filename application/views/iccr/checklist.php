...
foreach ($response as $resp) {
    if ($resp['regional_university'] == $applicaitonStepOne[0]['universty_choice']) {
        ...
        if ($resp['university_is_accept'] == 1) {
            ?>
               ...
               $sts = 0;
                foreach ($response as $resp) {
                    if ($resp['regional_university'] == $applicaitonStepOne[0]['universty_fifth']) {
                       $sts++;
                        if (!empty($resp['course'])) {
							 echo $resp['course'];	
	...
	<hr />
      ...
      <!--	<div class="name-sec col-xs-4 col-sm-2 col-md-6 ">
		 ...
		 <div id="schemes_selection" class="passport-sec col-xs-12 col-sm-12 col-md-12 pdleft pdright scholardiv" style="margin-top: 20px; padding-top: 18px; padding-bottom: 18px; background: #5b84a6 none repeat scroll 0 0; padding-left: 12px; border: 12px; border: 1px solid rgb(206, 206, 206); color:#fff;">
		 <div class="row">
					<div class="form-group col-xs-3">
					    <!----<label for="inputEmail3" class="col-sm-7 control-label">Application Status  <span class="text-red">*</span></label>--->
						<label for="inputEmail3" class="col-sm-7 control-label">Scholarship confirmed<span class="text-red">*</span></label>
              		...
              		<div class="form-group col-xs-5 is_university_accepct">
					    <label for="inputEmail3" class="col-sm-5">Select Universities<span class="text-red">*</span></label>
					    <div class="col-sm-7">
					...
					<div class="form-group col-xs-4 is_university_accepct">
					    <label for="inputEmail3" class="col-sm-3">Course  <span class="text-red">*</span></label>
					    <div class="col-sm-7">
					...
					<div class="row">
              		...
              		<div class="form-group col-xs-3">
					    <label class="col-sm-7">Scholarship Programme: <span class="text-red">*</span></label>
					    <div class="col-sm-5">
					...
					<div class="form-group col-xs-5">
					    <label class="col-sm-5">Date(Time line)<span class="text-red">*</span></label>
					    <div class="col-sm-5">
