			...
			<tbody>
				...
				if(count($icar_applications)>0)
				{
					foreach($icar_applications as $app)
					{
						...
						if(empty($app['course']) && $app['course'] == '')
						{
							$programme = $this->common_model->getProgrammeById($app['programme']);
						...
						<td><?php if(!empty($app['mission_status_date']))
						{
							echo $app['mission_status_date'];
						...
						<td><a target="_blank"  href="<?php echo site_url();?>headquarter/applicationForm/<?php echo $app['application_no'];?>"><span class = "label label-success">Download</span></a></td>
						<td><a target="_blank" href="<?php echo site_url();?>headquarter/contactForm/<?php echo $app['application_no'];?>"><span class = "label label-success">Download</span></a></td>	
					    <td>
                             <?php 
