                    ...
                    foreach ($confirmationfromROs as $app) {
                        ...
                        if ($response[0]['response'] != "2,2,2") {
                            ...
                            <tr>
                                ...
                                <td><?php echo $app['fullname'].' '.$app['middlename'].' '.$app['familyname']; 
								$date1 = '2018-12-15';
                            ...
                            ?></td>		
                                ...
                                <td><?php
                                    ...
                                    foreach ($universties as $uni) {
                                        $u = $this->common_model->getUniversityByIdOld($uni);
                                        echo $u[0]['name'];
                                        echo "<br/>";
                                    }
                                    ?></td>						
                                ...
                                <td>
                                    <?php
									$region_date = date("Y-m-d", $app['region_one_status_date']);
                                    $docs = explode(';', $response[0]['docs']);
                                    $cont = 1;
                                    foreach ($docs as $doc) {
                                        ?>
                                        <a target="_blank" href="<?php echo site_url(); ?>assets/site/main/university_approval/<?php echo $doc; ?>" target="_blank">Download Letter <?php echo $cont?></a><?php echo ' ('.$region_date.')'?>
                                        <br>
                                        <?php
                                        $cont++;
                                    }
                                        ...
                                        if ($division == 1 || $division == 11 || $division == 12) {
                                            ...
                                            foreach ($uniar as $keyid => $respppp) {
                                                if ($respppp == 1) {
													...
													{
														?>
														<!----<a class="form-control sbmt" style="height:42px;width:140px;" href="JavaScript:Void(0);" disabled>(A) Forward To Mission</a>--->
														<a class="form-control sbmt" style="height:42px;width:140px;" href="<?php echo site_url(); ?>headquarter/beforeconfirmtoMission/<?php echo $app['application_no']; ?>/<?php echo $keyid; ?>">(A) Forward To Mission</a>
														<?php
													}
                                                    ?>
													...
													else
													{
														?>
														 ...
														 <!-----<a class="form-control sbmt" style="height:42px;width:140px;" href="JavaScript:Void(0);" disabled>(R) Forward To Mission</a>--->
														 <a class="form-control sbmt" style="height:42px;width:140px;" href="<?php echo site_url(); ?>headquarter/beforerejectiontoMission/<?php echo $app['application_no']; ?>/<?php echo $keyid; ?>">(R) Forward To Mission</a>
														<?php
