...
<section class="meacontent">	
	<div class="col-xs-10 form_head">		
		...
		<h3 class="text-center caps">Process RO Demand</h3>	
		<h5 class="text-center">TO BE FILLED BY ICCR</h5>
		
	</div>	
	<div class="headsec container">Welcome Indian Council For Cultural Relations to ICCR Scholarship Portal </div>
	<div  class="container" style="min-height:410px;padding:0px;">		
	<div class="tab-content footr">		
	  <div id="home" class="tab-pane fade in active">	   
	    <form id="form-expenditure" action="<?php echo site_url();?>headquarter/updateDemand/<?php echo $demandId; ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
	    	  ...
	    	  <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">		    	 								
					 <div class="form-group col-xs-9">
					    ...
					    <div class="col-sm-8">
					          ...
					          <select id="status" name="status" class="selectpicker form-control FY_DATEPICKER" required="true">
