...
<script type="text/javascript">
	function showExpenditure(id)
	{
		...
		if(fy != "")
		{
			location.href = baseURL + "headquarter/expenditureReportofStudentRegionWise/" + id + "/" + fy;
		}
		else
		{
	...
	function showTravelDetails(id)
	{
		//alert('ok');
		var fy = $('#fy_old_one').val();
		if(fy != "")
		{
			location.href = baseURL + "headquarter/joiningReportofStudentRegionWiseView/" + id + "/" + fy;
		}
		else
		{
			 BootstrapDialog.show({type: BootstrapDialog.TYPE_DANGER ,title: "Error Message" ,message: "Select Academic Year First."  ,buttons: [{label: 'OK',action: function(dialogItself) {dialogItself.close();}}]});
		}
	}
</script>
<section class="meacontent">
	<div  class="container" style="min-height:410px;padding-top:15px;">
			...
			<div class="blue-heading col-md-12 ">
			 <h3>Expenditure Details of Students</h3>
...
$(document).ready(function() {
	 ...
	 reprottable = $('.expreportTable').DataTable( {	
        ...
        "serverSide": true,
        "ajax": {
        	"url":"<?php echo site_url('headquarter/getExpStudentDetailsRegionWise')?>",
        	"type": "POST",
            "data": function ( data ) {
                data.FinancialYear = $('#fy_old_one').val();
				data.AcademicYear = $('#fy_old_one').val();
