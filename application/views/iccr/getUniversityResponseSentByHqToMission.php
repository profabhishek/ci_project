            ...
            <tbody>
                ...
                echo $sch[0]['scheme_name'];
						...
						<?php echo date("Y-m-d", strtotime($array['date']));?></td>	
                                ...
                                <td>
                                    ...
                                    foreach ($response as $resp) {
                                       if ($resp['University'] == $app['universty_choice_fifth'] || $app['universty_choice_fourth'] || $app['universty_choice_three'] || $resp['University'] == $app['universty_choice_two'] || $resp['University'] == $app['universty_choice']) {
                                            $sts++;
                                            if ($resp['response'] == 1) {
                                                ?>
                        ...
                        ?>
                               ...
                               ?>
                                 <a target="_blank" href="<?php echo site_url(); ?>assets/site/main/undertakings/<?php echo $app['undertaking_doc']; ?>" target="_blank">Download</a>
