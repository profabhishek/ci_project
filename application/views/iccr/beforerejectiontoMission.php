...
<hr>
	...
	<div class="cnfrmeddd">
		<form method="post" action="<?php echo site_url();?>headquarter/savenotconfirmedcourse/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>">
		<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">	
		<div class="form-group" style="margin-left:25%;">
			<label>Enter University Reason for Rejection</label>
			<br/><br/>
			<textarea style="width:80%;" rows="10" name="reason" id="reason" required="true"></textarea><br/><br/>
