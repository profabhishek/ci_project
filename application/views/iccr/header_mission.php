							...
							<div class="collapse navbar-collapse" id="defaultNavbar2">
							  	<ul class="nav navbar-nav">
							  		...
							  		$user = $this->session->userdata('user_data');
						   			...
						   			{
									?>
										<li><a href="<?php echo site_url();?>headquarter" class="active">Home</a></li>
									<?php		
									}
									else
									{
									?>
										<li><a href="<?php echo site_url();?>headquarter/dashboard" class="active">Home</a></li>										
									<?php	
									}
							  		?>	
							  		<li><a href="<?php echo site_url();?>headquarter/instructions">Headquarter Portal</a></li>
							  		<li>
										...
										<ul class="dropdown-menu">
												...
												<li class="last"><a target="_blank" href="<?php echo site_url();?>assets/site/docs/guidelines-for-mission-amended.pdf">Mission Guidelines</a></li>
												<li><a target="_blank" href="<?php echo site_url();?>assets/site/docs/guidelines-for-ROs.pdf">Regional Guidelines</a></li>
												<li><a target="_blank" href="<?php echo site_url();?>assets/site/docs/Guidelines_for_university.pdf">University Guidelines</a></li>
									            <li class="last"><a target="_blank" href="<?php echo site_url();?>assets/site/docs/applicant_guidelines_beforefilling.pdf">Applicant Guidelines Before Login</a></li>
									           <!-----<li><a target="_blank" href="<?php echo site_url();?>regional/hqrs_guidlines">HQRS Guidelines</a></li>---->											   
									    </ul>
							  		</li>
							  		<!--<li><a href="<?php echo site_url();?>headquarter/payexpendituretoregion">Regional Expenditure</a></li>-->
						  			<!----<li>
							  		<a href="#" class="dropdown-toggle" data-toggle="dropdown">Downloads <b class="caret"></b></a>
							  		<ul class="dropdown-menu">
								          <li><a href="<?php echo site_url();?>headquarter/expenditure" download>Expenditure Statement</a></li>
							   	...
							   	<ul class="nav navbar-nav pull-right">
							   		...
							   		<?php
										...
										?>
											<li>
								  				<a href="#" class="dropdown-toggle" data-toggle="dropdown">Headquarter Profile &nbsp; <b class="caret"></b></a>
										  		<ul class="dropdown-menu">
											        <li><a href="<?php echo base_url();?>headquarter/profile">Profile</a></li>
													<li><a href="<?php echo base_url();?>headquarter/changepassword">Change Password</a></li>
													<li><a href="<?php echo base_url();?>headquarter/logout">Logout</a></li>
											    </ul>							  			     
							  				</li>
										<?php		
										}										
