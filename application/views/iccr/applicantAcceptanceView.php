				...
				<div class="col-xs-3 prfl pull-right" >
              	...
              	<div class="name-sec col-xs-12 col-sm-9 col-md-9 pdleft pdright">
					...
					?>
								...
								<tr>
							<td style="min-height:35px;font-weight: bold;">
									<label><b>9. University/Institute </b></label>
								</td>						
							</tr>
							<tr> 
								<td colspan="3" style="min-height:35px;">
              		...
              		<tbody>
						...
						<tr>
							...
							<td> 
							<?php if (count($mappingData) > 0 && $mappingData[0]["undertaking_doc"] != "NULL" && $mappingData[0]["undertaking_doc"] != "") 
							{
                                    echo "<div class='col-sm-4'> <a class='link_div' download href='".site_url()."assets/site/main/undertakings/".$mappingData[0]['undertaking_doc']."'>Download</a></div>";
                                } else {
							...
							<td>
                                    ...
                                    <?php
									$response1 = $this->common_model->getUniversityResponsesbyHqrs($data->application_id);
                                    ...
                                    foreach ($response1 as $resp) {
                                      /*  if ($resp['University'] == $app['universty_choice_three'] || $resp['University'] == $app['universty_choice_two'] || $resp['University'] == $app['universty_choice']) { */
                                            ...
                                            if ($resp['response'] == 1) {
                                                ?>
                                                <a target="_blank" href="<?php echo site_url(); ?>headquarter/confirmationReceivedWithFormatIcar/<?php echo $data->application_id; ?>/<?php echo $resp['University']; ?>" target="_blank">Download</a>

                        <?php
                    } elseif ($resp['response'] == 2) {
                        ?>
                                                <a target="_blank" href="<?php echo site_url(); ?>headquarter/confirmationNotReceivedWithFormatIcar/<?php echo $data->application_id; ?>/<?php echo $resp['University']; ?>" target="_blank">Download</a>
                                                <?php
                                            }
                                        }
              	...
              	<table class="table" id="tbl_relation" style="width:100%;">
              		...
              		<tbody>
              			<tr>
              				<td>
              					<?php               					
								$status = $mappingData[0]['scholar_acceptance'];							
								if($status == 1)								
								echo "Accepted by Applicant";
								elseif($status == 2)								
								echo "Declined by Applicant";
							?>
              				</td>
              			</tr>
              		</tbody>
