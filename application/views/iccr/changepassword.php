	...
	<div  class="container" style="min-height:241px;padding:0px;">		
		<div class="tab-content footr">		
			<div id="home" class="tab-pane fade in active">	   
				<form id="form-changepassword" role="form" data-toggle="validator" action="<?php echo site_url();?>headquarter/changepassword" method="post" class="form-horizontal" enctype="multipart/form-data" onsubmit="return getPass();">
					<div class="box-body">
						<?php
						...
						<div class="form-group col-xs-9">
							...
							<div class="col-sm-8">					    
								<input type="password" data-minlength="6" class="form-control" id="newpassword" name="newpassword" placeholder="Password" required="true"/>
								<div id="pswd_info">
