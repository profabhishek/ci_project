...
foreach ($response as $resp) { 
	...
	//echo '-1-'.$resp['regional_university'];
	//echo '-2-'.$applicaitonStepOne[0]['universty_choice'];
	/*if($i==1){$universty_choice=$university_first[0]['id'];}
	if($i==2){$universty_choice=$applicaitonStepOne[0]['universty_choice_two'];}
	if($i==3){$universty_choice=$applicaitonStepOne[0]['universty_choice_three'];}
	if($i==4){$universty_choice=$applicaitonStepOne[0]['universty_choice_fourth'];}
	if($i==5){$universty_choice=$applicaitonStepOne[0]['universty_choice_fifth'];}*/
	
		
    if ($resp['regional_university'] == $university_first[0]['id']) {
...
$file_path_un = './'.$currentyear.'/university_approval/'.$resp['region_one_doc'];  
                           if(strpos($resp['region_one_doc'],'.pdf')){
							 $output = '<a href="'.site_url().'assets/site/main/university_approval/'.$resp['region_one_doc'].'" target = "_blank">Download</a>';   
						   }
                            else {
						$file_path_un = '/'.$currentyear.'/university_approval/'.$resp['region_one_doc'];		
						     $imgs = file_get_contents($file_path_un);
                                        ...
                                        if ($resp['university_is_accept'] == 1) {
											...
											elseif($oldYear == 2022||$oldYear == 2023||$oldYear == 2024||$oldYear == 2025||$oldYear == 2026)
											{
												?>
												 ...
												 <?php
                                                         if(strpos($resp['region_one_doc'],'.pdf')){ ?>
							 <a href="<?php echo site_url().'headquarter/downloadDocs/'.base64url_encode($file_path_un); ?>" target = "_blank">Download</a>
						  <?php } 
                            else {	
						     $imgs = file_get_contents($file_path_un);
							 $data = base64_encode($imgs);
...
foreach ($response as $resp) {
    if ($resp['regional_university'] == $response[0]['regional_university']) {
        ...
        <td>
            ...
            ?>
            <a target="_blank" href="<?php echo site_url(); ?>headquarter/confirmationNotReceivedWithFormat/<?php echo $this->uri->segment(3); ?>/<?php echo $resp['regional_university']; ?>" target="_blank">Download</a>
            <?php
                }
                    }
                        }
                              ...
                              //echo "<pre>";print_r($mappingData);
                                   if($mappingData[0]['mission_status'] == 1 && $mappingData[0]['scholar_acceptance'] == 1) {
                                        if ($response[0]['university_is_accept'] == 1) {
                                            ?>
                                            <a target="_blank" href="<?php echo site_url(); ?>Headquarter/undertakingFromStudent/<?php echo $response[0]['application_id']; ?>/<?php echo $university[0]['regional_university']; ?>" target="_blank"><span class = "label label-success">Download</span></a>
							...
							<tr>
								...
								<td>
								  ...
								  if(array_key_exists($doctypes['id']['type'],$docsArray))
								  {
								  	$upload++;
								  ?>
								   <a href="<?php echo site_url().'headquarter/downloadDocs/'.base64url_encode($file_path); ?>"><i class="fa fa-file-pdf-o fa-1x text-red"></i> Click to view Document</a>
								  <?php	
								  }
								  else
								  {
							...
							<tr>
								...
								<?php
								  if(array_key_exists($doctypes['passport']['type'],$docsArray))
								  {
								  	$upload++;
								  ?>
								  <a target="_blank" href="<?php echo site_url().'headquarter/downloadDocs/'.base64url_encode($file_path_passport); ?>"><i class="fa fa-file-pdf-o fa-1x text-red"></i> Click to view Document</a>
								  <?php	
								  }
								  else
								  {
							...
							<tr>
								...
								<?php
								  if(array_key_exists($doctypes['school_leaving_x']['type'],$docsArray))
								  {
								  	$upload++;
								  ?>
								   <a target="_blank" href="<?php echo site_url().'headquarter/downloadDocs/'.base64url_encode($file_path_school_leaving_x);?>"><i class="fa fa-file-pdf-o fa-1x text-red"></i> Click to view Document</a>
								  <?php	
								  }
								  else
								  {
							...
							<tr>
								...
								<?php
								  if(array_key_exists($doctypes['school_leaving']['type'],$docsArray))
								  {
								  	$upload++;
								  ?>
								  <a target="_blank" href="<?php echo site_url().'headquarter/downloadDocs/'.base64url_encode($file_path_school_leaving); ?>"><i class="fa fa-file-pdf-o fa-1x text-red"></i> Click to view Document</a>
								  <?php	
								  }
								  else
								  {
							...
							<tr>
								...
								<?php
								  if(array_key_exists($doctypes['ug']['type'],$docsArray))
								  {
								  	$upload++;
								  ?>
								  <a target="_blank" href="<?php echo site_url().'headquarter/downloadDocs/'.base64url_encode($file_path_ug); ?>"><i class="fa fa-file-pdf-o fa-1x text-red"></i> Click to view Document</a>
								  <?php	
								  }
								  else
								  {
							...
							<tr>
								...
								<?php
								  if(array_key_exists($doctypes['pg']['type'],$docsArray))
								  {
								  	$upload++;
								  ?>
								 <a target="_blank" href="<?php echo site_url().'headquarter/downloadDocs/'.base64url_encode($file_path_pg); ?>"><i class="fa fa-file-pdf-o fa-1x text-red"></i> Click to view Document</a>
								  <?php	
								  }
								  else
								  {
							...
							<tr>
								...
								<?php
								  if(array_key_exists($doctypes['mhil']['type'],$docsArray))
								  {
								  	$upload++;
								  ?>
								   <a target="_blank" href="<?php echo site_url(); ?><?php echo site_url().'headquarter/downloadDocs/'.base64url_encode($file_path_mphil); ?>"><i class="fa fa-file-pdf-o fa-1x text-red"></i> Click to view Document</a>
								  <?php	
								  }
								  else
								  {
							...
							<tr>
								...
								<?php
								  if(array_key_exists($doctypes['phd']['type'],$docsArray))
								  {
								  	$upload++;
								  ?>
								   <a target="_blank" href="<?php echo site_url().'headquarter/downloadDocs/'.base64url_encode($file_path_phd); ?>"><i class="fa fa-file-pdf-o fa-1x text-red"></i> Click to view Document</a>
								  <?php	
								  }
								  else
								  {
							...
							<tr>
								...
								<?php
								  if(array_key_exists($doctypes['phdReseachPaper']['type'],$docsArray))
								  {
								  	$upload++;
								  ?>
								  <a target="_blank" href="<?php echo site_url().'headquarter/downloadDocs/'.base64url_encode($file_path_phdReseachPaper);?>"><i class="fa fa-file-pdf-o fa-1x text-red"></i> Click to view Document</a>
								  <?php	
								  }
								  else
								  {
							...
							<tr>
								...
								<?php
								  if(array_key_exists($doctypes['indian_address']['type'],$docsArray))
								  {
								  	$upload++;
								  ?>
								  <a target="_blank" href="<?php echo site_url().'headquarter/downloadDocs/'.base64url_encode($file_path_indian_address); ?>"><i class="fa fa-file-pdf-o fa-1x text-red"></i> Click to view Document</a>
								  <?php	
								  }
								  else
								  {
							...
							<tr>
								...
								<?php
								  if(array_key_exists($doctypes['dl']['type'],$docsArray))
								  {
								  	$upload++;
								  ?>
								  <a target="_blank" href="<?php echo site_url().'headquarter/downloadDocs/'.base64url_encode($file_path_d1); ?>"><i class="fa fa-file-pdf-o fa-1x text-red"></i> Click to view Document</a>
								  <?php	
								  }
								  else
								  {
							...
							<!--<tr>
								...
								<?php
								  if(array_key_exists($doctypes['physical']['type'],$docsArray))
								  {
								  	$upload++;
								  ?>
								  <a target="_blank" href="<?php echo site_url().'headquarter/downloadDocs/'.base64url_encode($file_path_physical); ?>"><i class="fa fa-file-pdf-o fa-1x text-red"></i> Click to view Document</a>
								  <?php	
								  }
								  else
								  {
							...
							<tr>
								...
								<?php
								  if(array_key_exists($doctypes['tl']['type'],$docsArray))
								  {
								  	$upload++;
								  ?>
								  <a target="_blank" href="<?php echo site_url().'headquarter/downloadDocs/'.base64url_encode($file_path_tl); ?>"><i class="fa fa-file-pdf-o fa-1x text-red"></i> Click to view Document</a>
								  <?php	
								  }
								  else
								  {
							...
							<tr>
								...
								<?php
								  if(array_key_exists($doctypes['otherDoc']['type'],$docsArray))
								  {
								  	$upload++;
								  ?>
								  <a target="_blank" href="<?php echo site_url().'headquarter/downloadDocs/'.base64url_encode($file_path_otherDoc); ?>"><i class="fa fa-file-pdf-o fa-1x text-red"></i> Click to view Document</a>
								  <?php	
								  }
								  else
								  {
