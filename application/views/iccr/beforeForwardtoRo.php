...
<hr>
	...
	<div class="cnfrmeddd">
		<form method="post" action="<?php echo site_url();?>headquarter/saveforwardtoRo/<?php echo $this->uri->segment(3); ?>/<?php echo $this->uri->segment(4); ?>">
		<input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">	
		<div class="form-group col-md-6" style="margin-left:25%;">
			<label>Enter Reason for Re-Submit</label><br/><br/>
			<input type="text" class="form-control" name="forward_reason" id="confirmedCourse" required="true"/>
			<br/><br/>
			<input class="form-control sbmt" type="submit" value="Submit"/>
		</div>
