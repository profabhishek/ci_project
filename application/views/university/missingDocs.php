...
<section class="meacontent">
	<div  class="container" style="min-height:410px;padding-top:15px;">
		...
		<div class="blue-heading col-md-12 ">
			 <h3>Missing Docs Applications</h3>
			...
			<tbody>
				...
				if(count($missingDocs)>0)
				{
					...
					foreach($missingDocs as $app)
					{
						...
						<td><?php echo $app['fullname'].$new;?></td>
						...
						echo date('Y-m-d',$date2);?></td>
						<td><?php 
						$date1 = $app['created'];	
						echo date('Y-m-d',$date1);?></td>
						<td>
						<a style="float:left;width:104px;" href="<?php echo site_url();?>university/viewfullApplication/<?php echo $app['application_no'];?>" class="form-control sbmt1" target = "_blank">View</a>';
						</td>
											
						
						<!-----<td><a href="<?php echo site_url();?>university/viewApplication/<?php echo $app['application_no'];?>" class="form-control sbmt">Remarks</a></td>----->
						<td>
						<a href='javascript:void(0);' style='float:left;width:104px;' onclick ="editRemarks('<?php echo $app['application_no'];?>')" class='form-control sbmt1'>Click Here</a>
						</td>
