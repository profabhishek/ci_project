			...
			<tbody>
				...
				if(count($visaendrosment)>0)
				{
					...
					//	else
						...
						<td><a class="form-control sbmt1" style="width:100px;" href="<?php echo site_url();?>university/historyview/<?php echo $app['application_no'];?>">View</a></td>	
					<td>
						<?php 
						if($app['status'] == 13)
						{
							?>
							<a class="form-control sbmt" style="height:32px;width:95px;" href="<?php echo site_url();?>university/historyview/<?php echo $app['application_no'];?>">View</a>
							<?php
						}
