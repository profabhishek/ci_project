...
">
	...
	<div class="row">
		...
		<div class="col-12 col-sm-12 col-md-9 customdiv">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Streams and seats Allotment for Different Courses 
    ...
    <section class="content">
      ...
      <div class="row">
      	<div class="col-xs-12">
    	<div class="box">
			<div class="box-header">Create Seats Allotment for Different Courses</div>
			<?php echo form_open('university/createSeatsAllotmentMapping',array('class'=>'form-horizontal')); ?>
              <div class="box-body">
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="university_course_type" id="university_course_types" class="form-control" required="true">
				 ...
				 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="university_course" id="university_course" title="Please select Course" class="form-control" required="true">
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" id="seats" name="seats" placeholder="Seats" required="true" type="text">
                  </div>
                </div>              
              </div>
              <!-- /.box-body -->
