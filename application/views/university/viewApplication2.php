...
<?php
							 ...
							 if(count($applicaitonStepOne[0]['programme']) > 0 && $applicaitonStepOne[0]['programme'] == 4 && $applicaitonStepOne[0]['universty_choice'] == 189 || $applicaitonStepOne[0]['universty_choice'] == 176)
...
<div class="box-body">  
              	...
              	<div class="passport-sec col-xs-12 col-sm-12 col-md-12 pdleft pdright">
					<table class="table">
						...
						//	if(count($applicaitonStepTwo) > 0 && $applicaitonStepTwo[0]['school_leaving_country'] != "" && $applicaitonStepTwo[0]['school_leaving_country'] > 0)
							...
							?>		
								<?php							
							if(count($docsArray) > 0 && array_key_exists($doctypes['physical']['type'],$docsArray))
							{	
							?>
							<tr>
								<td><?php echo $counter; $counter++;?></td>
 ...
 if(count($applicaitonStepOne[0]['programme']) > 0 && $applicaitonStepOne[0]['programme'] == 4 && $applicaitonStepOne[0]['universty_choice'] == 189 && $applicaitonStepOne[0]['course_type'] == 6 || $applicaitonStepOne[0]['universty_choice_two'] == 189 && $applicaitonStepOne[0]['course_type'] == 6 || $applicaitonStepOne[0]['universty_two_three'] == 189 && $applicaitonStepOne[0]['course_type'] == 6 || $applicaitonStepOne[0]['universty_choice'] == 205 && $applicaitonStepOne[0]['course_type'] == 6 || $applicaitonStepOne[0]['universty_choice_two'] == 205 && $applicaitonStepOne[0]['course_type'] == 6 || $applicaitonStepOne[0]['universty_choice_three'] == 205 && $applicaitonStepOne[0]['course_type'] == 6 || $applicaitonStepOne[0]['universty_choice'] == 176 && $applicaitonStepOne[0]['course_type'] == 6 || $applicaitonStepOne[0]['universty_choice_two'] == 176 && $applicaitonStepOne[0]['course_type'] == 6 || $applicaitonStepOne[0]['universty_choice_three'] == 176 && $applicaitonStepOne[0]['course_type'] == 6 )
							{
								?>
							<tr>
								<td><?php echo $counter; $counter++;?></td>
		...
		<div class="name-sec col-xs-4 col-sm-2 col-md-6 pull-right">
	       ...
	       <div class="name-sec col-xs-4 col-sm-2 col-md-3 pull-right">
	         	<?php if($this->uri->segment(4) != "")
	         		  {
	         		  	?>
					  	<a href="javascript:void(0);" onclick="applicaiton_process_pending_by_university('Pending','<?php echo $this->uri->segment(3); ?>','');" class="form-control sbmt">Process</a>
					  	<?php
	         		  }
	         		  else
	         		  {
					  	?>
					  	<a href="javascript:void(0);" onclick="applicaiton_process_by_university('Process','<?php echo $this->uri->segment(3); ?>','');" class="form-control sbmt">Process</a>
					  	<?php
					  }
	         	 ?>
