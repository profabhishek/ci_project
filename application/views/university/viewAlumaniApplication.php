...
<section class="meacontent">	
	...
	<form method="post" action="<?php echo base_url();?>mission/downloadAlumniApplication/<?php echo $this->uri->segment(3); ?>" enctype="multipart/form-data" id="frm_details_ngo" name="frm_details_ngo" style="width: 100%;position: relative;top: -43px;
">
              	...
              	<div class="name-sec col-xs-12 col-sm-9 col-md-9 pdleft pdright">
					<table id="fbl_main" style="width: 100%;">
					   ...
					   <?php if(!empty($alunamiapplication)) echo $alunamiapplication[0]['fullname'];?>	</td>
							...
							<tr >
								<td style="height:35px;font-weight:bold;"><label>2. Age</label></td>
								<td align="left" style="height:35px;">:&nbsp;&nbsp;
					   <?php if(!empty($alunamiapplication)) echo $alunamiapplication[0]['age'];?>	</td>
							</tr>
							<tr>
							...
							<tr >
								<td style="font-weight:bold;height: 35px;"><label>4. Gender</label></td>
								<td>:&nbsp;&nbsp;<?php $title = '';
					  ...
					  ?></td>
						  ...
						  ?>
							...
							<tr>
								<td style="height:35px;font-weight: bold;">
								<label>6. Scheme</label></td>
											<td>:&nbsp;&nbsp;<?php
											$schemee = $this->common_model->getSchemeById($alunamiapplication[0]['scholarship_scheme']);
							...
							<tr>
								<td style="height:35px;font-weight: bold;">
								<label>10. Duration of Course</label>
								</td>
								<td>:&nbsp;&nbsp;
								<?php 
								if(!empty($alunamiapplication))
							...
							<tr>
								<td style="height:35px;font-weight: bold;">
								<label>11. Year of Passing</label>
								</td>
								<td>:&nbsp;&nbsp;
								<?php 
								if(!empty($alunamiapplication))
							...
							<tr>
								<td style="height:35px;font-weight: bold;">
								<label>12. Present Details</label>
								</td>
								<td>:&nbsp;&nbsp;
								<?php 
								if(!empty($alunamiapplication))
								...
								<tr>
								<td style="height:35px;font-weight: bold;">
								<label>13. Occupation/Professional Address</label>
								</td>
								<td>:&nbsp;&nbsp;
								<?php 
								if(!empty($alunamiapplication))
								{
									if($alunamiapplication[0]['occupation'] == 7)
									{
										echo $alunamiapplication[0]['occupation_other'];
									}
									else
									{
										$crs = $this->common_model->getOccupationsById($alunamiapplication[0]['occupation']);
										echo $crs[0]['occupation'];
									}
								}
							...
							<tr>
								...
								<tr>
								<td style="height:35px;font-weight: bold;">
								<label>16. Award Recognition</label>
								</td>
								<td>:&nbsp;&nbsp;
								<?php 
								if(!empty($alunamiapplication))
							...
							<tr>
								<td style="height:35px;font-weight: bold;">
								<label>17. Mission Special Remarks</label>
								</td>
								<td>:&nbsp;&nbsp;
								<?php 
								if(!empty($alunamiapplication))
								{
									echo $alunamiapplication[0]['mission_special_remarks'];
								}
