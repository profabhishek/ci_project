	...
	<a href="<?php echo site_url();?>mission/dashboard" class="backbtn">
		...
		<!----<div class="col-12 col-sm-12 col-md-3 left-menu-sec">
			...
			<li><a href="<?php echo site_url(); ?>university/missingDocs">Cases of Missing Documents<span class="pull-right fltright"><?php echo $countresubmitapplication; ?></span></a></li>
	          ...
	          <li><a href="<?php echo site_url(); ?>university/resubmitapplication">Cases of Re-Submission by Applicant<span class="pull-right fltright"><?php echo $countresubmitapplication; ?></span></a></li>
