...
<section class="meacontent">	
	...
	<form method="post" action="<?php echo base_url();?>mission/downloadApplication" enctype="multipart/form-data" id="frm_details_ngo" name="frm_details_ngo" style="width: 100%;position: relative;top: -43px;
">
