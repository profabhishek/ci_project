	  ...
	  <div id="home" class="tab-pane fade in active">	
              ...
              <div class="box-body">
              	...
              	<div class="name-sec col-xs-12 col-sm-9 col-md-9 pdleft pdright">
						  ...
						  ?></td>
							...
							<tr>
								...
								<table id="tbl_father" class="table" style="width:100%;">
									...
									<tbody>
										<tr>
											<td ><?php if(!empty($applicaitonStepOne)) echo $applicaitonStepOne[0]['father_fname'] .' '.$applicaitonStepOne[0]['father_mname'].' '.$applicaitonStepOne[0]['father_lname'];?>	 </td>
											<td><?php if(!empty($applicaitonStepOne) && !empty($applicaitonStepOne[0]['father_fname'])) echo 'Father';?></td>
											<td><?php if(!empty($applicaitonStepOne)) echo $applicaitonStepOne[0]['father_occupation'];?></td>
											...
											<td><?php
											if(!empty($applicaitonStepOne) && !empty($applicaitonStepOne[0]['father_fname'])){
									  $nationalities = $this->common_model->getCountries();
									  foreach($nationalities as $na)
									  {
									  	if(!empty($applicaitonStepOne))
									  ...
									  ?></td>
										...
										<tr>
											<td ><?php if(!empty($applicaitonStepOne)) echo $applicaitonStepOne[0]['mother_fname'].' '.$applicaitonStepOne[0]['mother_mname'].' '.$applicaitonStepOne[0]['mother_lname'];?>	 </td>
											<td><?php if(!empty($applicaitonStepOne) && !empty($applicaitonStepOne[0]['mother_fname'])) echo 'Father';?></td>
											<td><?php if(!empty($applicaitonStepOne)) echo $applicaitonStepOne[0]['mother_occupation'];?></td>
											...
											<td><?php
											if(!empty($applicaitonStepOne) && !empty($applicaitonStepOne[0]['mother_fname'])){
									  $nationalities = $this->common_model->getCountries();
									  foreach($nationalities as $na)
									  {
									  	if(!empty($applicaitonStepOne))
					...
					<?php 
					if($applicaitonStepOne>0 && $applicaitonStepOne[0]['programme'] == 1 || $applicaitonStepOne[0]['programme'] == 2 || $applicaitonStepOne[0]['programme'] == 9)
					{
					...
					<tbody>
						...
						<?php
							...
							<tr><td  style="height: 25px;font-weight: bold; text-align: left;"> 
								<label for="comment" >18. Any Other Information: </label> <?php if(!empty($applicaitonStepThree)) echo $applicaitonStepThree[0]['any_other_info'];?>
									
								</td>						
							<tr>
							<tr><td  style="height: 25px;font-weight: bold; text-align: left;"> 
								<label for="comment" >19. English Proficiency Test: </label> <?php if(!empty($applicaitonStepThree)) echo $applicaitonStepThree[0]['english_test'];?>
