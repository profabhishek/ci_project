			...
			<tbody>
				...
				if(count($listofacceptance)>0)
				{
					foreach($listofacceptance as $app)
					{
						...
						<td>
						<?php  $universityData = $this->common_model->getUniversityById($app['regional_university']);
					 ...
					 <td>
                        ...
                        if ($app['scholar_acceptance'] == 1){
                         ?>
                        <a target="_blank" href="<?php echo site_url(); ?>mission/offerReceivedWithFormat/<?php echo $app['application_no']; ?>/<?php echo $app['regional_university']; ?>" target="_blank"><span class = "label label-success">Download</span></a>
					<?php
						}
						else
						{
					...
					if($app['scholar_acceptance'] == 1)
					{
						...
						<a target="_blank" href="<?php echo site_url(); ?>applicant/undertakingFromStudent/<?php echo $app['application_no']; ?>/<?php echo $app['regional_university']; ?>" target="_blank"><span class = "label label-success">Download</span></a>
					...
					<td><a class="form-control sbmt1" style="width:100px;" href="<?php echo site_url();?>mission/viewfullApproveApplication/<?php echo $app['application_no'];?>">View</a></td>
					...
					<td><?php	
							...
							if(!empty($app['undertaking_doc']) && $app['visa_from_date'] != NULL)
					{
								?>
							...
							else
							{
								...
								?>
								<a href="javascript:void(0);" style="float:left;width:104px;" class="form-control sbmt1" disabled>Process</a>
								<?php	
