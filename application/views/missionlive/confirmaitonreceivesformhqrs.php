				...
				if(count($confirmationForwardtoMissionbyHqrs)>0)
				{
					foreach($confirmationForwardtoMissionbyHqrs as $app)
					{
						...
						<?php if(empty($scheme))
						{
							...
							<a title = "Please update the scheme." class="form-control sbmt" style="width:100px;" href="<?php echo site_url();?>mission/processConfirmedappfromhqrs/<?php echo $app['application_no'];?>" class="btn btn-block btn-default" disabled="disabled" onclick="return false;">Process</a>
							<?php
