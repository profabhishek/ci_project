							...
							<div class="collapse navbar-collapse" id="defaultNavbar2">
							  	<ul class="nav navbar-nav">
									...
									<?php	
							  		...
							  		<li><a href="<?php echo site_url();?>assets/site/downloads/ICCR_UserManual_Mission.docx">User Manual</a></li>
							  		<li>
							  		<a href="#" class="dropdown-toggle" data-toggle="dropdown">Guidelines &nbsp; <b class="caret"></b></a>
							  		<ul class="dropdown-menu">
								          <!-----<li><a href="<?php echo site_url();?>mission/applicant_guidlines">Applicant Guidelines</a></li>--->
										  <li><a href="<?php echo site_url();?>assets/site/docs/Timeline-AY-2021-22.pdf" target = "_blank">Time Line AY 2021-2022</a></li>
										  <li><a href="<?php echo site_url();?>assets/site/docs/applicant_guidelines_beforefilling.pdf" target = "_blank">Applicant Guidelines</a></li>
								          <li><a href="<?php echo site_url();?>assets/site/docs/guidelines-for-mission-amended.pdf" target = "_blank">Mission Guidelines</a></li>
							  		...
							  		<a href="#" class="dropdown-toggle" data-toggle="dropdown">Downloads &nbsp; <b class="caret"></b></a>
								  		<ul class="dropdown-menu">
								  			<li><a download href="<?php echo site_url();?>assets/site/docs/Mission_CheckList.pdf">Mission Check List</a></li>
