      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
			 ...
			 <li><a href="<?php echo site_url();?>admin/allStreams"><i class="fa fa-book"></i> All Streams</a></li>
			 ...
			 <li><a href="<?php echo site_url();?>admin/addStream"><i class="fa fa-book"></i>Stream Mapping</a></li>
			...
			<li><a href="<?php echo site_url();?>admin/addTestimonials"><i class="fa fa-book"></i> Create Testimonials</a></li>
			<li><a href="<?php echo site_url();?>admin/allTestimonials"><i class="fa fa-book"></i> All Testimonials</a></li>
