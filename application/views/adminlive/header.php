...
<script src="<?php echo base_url();?>assets/site/main/js/buttons.colVis.min.js"></script>
...
<style type="text/css">
	header{
		background: url(<?php echo site_url();?>assets/site/main/images/indian-flag.png) 100%;
