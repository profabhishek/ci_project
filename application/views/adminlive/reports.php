  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
    	...
    	<div class="box">
			...
			<div class="pull-right"><a href="<?php echo site_url();?>admin/downloadTotalRoApplication">
    ...
    <div class="input-group input-daterange">
      ...
      <input type="text" id="max-date" class="form-control date-range-filter" data-date-format="yyyy-mm-dd" placeholder="To:">
			...
			<div class="box-body">
	      	<table id = "myreporttable" class="table table-bordered table-striped myMissions">
	       	<thead>
	       		<thead>
				<th>S.No.</th>				
