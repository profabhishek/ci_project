  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Universities 
        <small>All Universities</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo site_url();?>admin/allmissions"><i class="fa fa-dashboard"></i> Universities List</a></li>
    ...
    <section class="content">
      ...
      <div class="row">
      	<div class="col-xs-12">
    	<div class="box">
			<div class="box-header">Universities List<div class="pull-right"><a href="<?php echo site_url();?>admin/downloadUniversityList">
			<img style="width: 32px; height: 30px; margin-left: 16px;" src="<?php echo site_url();?>assets/site/main/images/xls_icon.png"/></a></div><div class="pull-right"><a href="<?php echo site_url();?>admin/addUniversity">Add University</a></div></div>
			
			<div class="box-body">
	      	<table class="table table-bordered table-striped myMissions" id="example">
	       	<thead>
	       		<th>S.No.</th>	       			       		
	       	...
	       	<tbody>
				...
				<tr>
					...
					<td><?php echo $university['stname'];?></td>													
					<td><?php echo $university['statename'];?></td>													
					<td><?php echo $university['title'];?></td>	
					<td><?php if($university['university_type'] == 1){echo 'Central';}elseif($university['university_type'] == 2){echo 'State';}elseif($university['university_type'] == 8){echo 'Ayush';};?></td>	
					<td><?php if($university['status'] == 1){echo 'Active';}else{echo 'Deactive';};?></td>											
					 <td>
