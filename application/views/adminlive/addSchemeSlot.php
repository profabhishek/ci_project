    ...
    <section class="content">
      ...
      <div class="row">
    	...
    	<div class="box">
			...
			<?php echo form_open('admin/createSeatsAllotment',array('class'=>'form-horizontal')); ?>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select name="schemecountry" id="schemecountry" title="Please select Country" class="form-control" required="true">
